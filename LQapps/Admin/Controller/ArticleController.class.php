...
class ArticleController extends PublicController{
	...
	protected $myForm = array(
		...
		array('text', 'zc_title', "文章标题",1,'{"required":"1","dataType":"","dataLength":"","readonly":0,"disabled":0,"maxl":120}'),
		...
		//内容
		'2'=>array(
		array('textarea', 'zc_summary', "文章摘要",1,'{"required":"0","dataType":"","dataLength":"","readonly":0,"disabled":0}'),
		array('editor', 'zc_content', "文章内容",1,'{"required":"0","model":"1","ext":"LQF","width":"100%","height":"300px"}'),		
		),
		//文章属性
		'3'=>array(
		array('text', 'zc_source', "文章来源",1,'{"required":"0","dataType":"","dataLength":"","readonly":0,"disabled":0}'),
		array('text', 'zc_source_url', "文章来源链接",1,'{"required":"0","dataType":"","dataLength":"","readonly":0,"disabled":0}'),
    ...
    public function index() {
		...
		$page_config = array(
				'field'=>"`id`,`zn_cat_id`,`zc_image`,`zc_title`,`zn_sort`,`zl_is_index`,`zl_is_good`,`zl_visible`",
