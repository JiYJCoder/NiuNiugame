...
class AttachmentController extends PublicController{
    ...
    public function index() {
		...
		//首页设置
		$page_title=array('checkbox'=>'checkbox','no'=>L("LIST_NO"),'id'=>L("LIST_ID"),'zc_account'=>'上传用户','zn_type'=>'文件类别','zc_original_name'=>'文件名','zc_suffix'=>'文件后缀','time'=>'上传时间');
		$page_config = array(
				'field'=>"`id`,`zc_account`,`zn_type`,`zc_original_name`,`zc_suffix`,`zn_cdate`",
