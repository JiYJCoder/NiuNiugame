...
class PayLogController extends PublicController{
    /** 初始化*/
    ...
    public function index() {
		...
		$page_config = array(
				'field'=>"`id`,`zc_order_no`,`zc_pay_type`,`zn_pay_business`,`zc_member_account`,`zf_order_amount`,`zl_is_apy`,`zc_transaction_id`,`zn_cdate`,`zn_mdate`",
