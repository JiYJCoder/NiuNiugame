<?php //接口文档说明 ApiDocument 页面操作 
namespace Admin\Controller;
use Think\Controller;
use LQLibs\Util\BootstrapForm as Form;//表单填充插件

class ApiDocumentController extends PublicController{
	public $myTable;
	protected $myForm = array(
		...
		//基本信息
		'1'=>array(
		array('select', 'zl_type', "接口分类",1,'{"required":"1","dataType":"","dataLength":"","readonly":0,"disabled":0,"please":"请选择"}'),
		array('text', 'zc_title', "接口标题",1,'{"required":"1","dataType":"","dataLength":"","readonly":0,"disabled":0}'),
		array('text', 'zc_url', "接口地址",1,'{"required":"1","dataType":"","dataLength":"","readonly":0,"disabled":0}'),
		array('text', 'zn_sort', "排序",1,'{"required":"1","dataType":"number","dataLength":"","readonly":0,"disabled":0}'),
		array('editor', 'zc_content', "接口内容",1,'{"required":"0","model":"1","ext":"LQF","width":"100%","height":"300px"}'),		
		),
	);
    /** 初始化*/
    ...
    public function index() {
		...
		//首页设置
		$page_title=array('checkbox'=>'checkbox','no'=>L("LIST_NO"),'id'=>L("LIST_ID"),'zl_type'=>'分类','zc_title'=>'接口','status'=>L("LIST_STAYUS"),'os'=>L("LIST_OS"));
		$page_config = array(
				'field'=>"`id`,`zl_type`,`zc_title`,`zl_visible`",
    ...
    public function add() {
        if (IS_POST) {
			...
			$form_array["zl_type_data"]=C("API_DOCUMENT_TYPE");
	...
	public function sort() {
		$list =$this->myTable->where('1')->order('zn_sort,id desc')->field("`id`,`zc_title` as label")->select();
