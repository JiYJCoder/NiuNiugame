...
class MemberFavoriteController extends PublicController
{
    public $myTable;
    protected $myForm = array(
        ...
        //通用信息
        '1' => array(
            array('text', 'zc_fid', "课程分类", 1, '{"required":"1","dataType":"","dataLength":"","readonly":0,"disabled":0,"maxl":120}'),
            array('text', 'zc_image', "封面图", 1, '{"type":"images","allowOpen":1}'),
    ...
    public function index()
    {
        ...
        if ($search_content_array["fkeyword"] && $search_content_array["fkeyword"] != $this->keywordDefault) {
            if ($search_content_array["keymode"] == 1) {
                $sqlwhere_parameter .= " and (zc_member_account ='" . $search_content_array["fkeyword"] . "' or zc_teacher_account ='" . $search_content_array["fkeyword"] . "') ";
            } else {
                $sqlwhere_parameter .= " and (zc_member_account like' %" . $search_content_array["fkeyword"] . "%' or zc_teacher_account like '%" . $search_content_array["fkeyword"] . "%') ";
            }
        }
        ...
        if ($search_content_array["recommend"]) {
             $sqlwhere_parameter .= " and zn_type = ".$search_content_array["recommend"];
        }
        if ($search_content_array["member_id"]) {
            $sqlwhere_parameter .= " and zn_member_id = ".$search_content_array["member_id"];
        }
        ...
        $page_config = array(
            'field' => "`id`,`zn_cat_id`,`zn_fid`,`zn_type`,`zn_object_id`,`zn_member_id`,`zc_member_account`,`zn_teacher_id`,`zc_teacher_account`,`zn_cdate`",
