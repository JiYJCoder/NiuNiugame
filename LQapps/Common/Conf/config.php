...
$config_array = array(
	...
	//工装订单状态
    'HD_APPLICATION_TYPE'=>array(1=>'一键报价',2=>'申请设计',3=>'活动订单'),//咨询类别
	'HD_ORDER_STATUS'=>array(0=>'待处理',1=>'已完成',2=>'装修中',3=>'用户取消',4=>'平台取消'),
	'HD_APPLICATION_PROGRESS'=>array(1=>'服务响应',2=>'预约上门',3=>'上门测量',4=>'出效果图',5=>'选材',6=>'交底报价',7=>'执行签约'),
	'HD_APPLICATION_STATUS'=>array(0=>'未处理',1=>'已受理',2=>'成功预约',3=>'到访不遇',4=>'电话不通',5=>'不确定时间',6=>'客户回绝',7=>'签约成功',8=>'客户确认',9=>'客户调整',10=>'客户取消'),	
	...
	//工装订单进程
	'PROJECT_PROGRESS'=>array(1=>'上门测量',2=>'出效果图',3=>'选材',4=>'交底报价',5=>'签约成功',6=>'缴款（第一期）',7=>'效果图',8=>'办理许可证',9=>'办理出入证',10=>'交钥匙',11=>'出施工图',12=>'拆改
（墙体、厨卫拆除）',13=>'水电（铺设电线、水管）',14=>'缴款（第二期）',15=>'泥木（贴砖、打柜、吊顶）',16=>'墙面（木漆、墙漆）',17=>'软装进场，布置完成',18=>'绿化、空气净化（空气监测）',19=>'缴款（第三期）',20=>'验房（竣工验收）',21=>'结算尾款'),
	'DECORATION_TYPE'=>array(1=>'毛坯装修',2=>'旧房改造',3=>'局部改造'),
   ...
   //网站公共数组e
	...
	//支付类型
	'PAY_BUSINESS'=>array(1=>'家装订单订金'),
	//活动游戏类型
	'ACTIVITY_GAME_MODE'=>array(1=>'通用',2=>'大转盘',3=>'斗地主',4=>'王者荣耀'),
	//数据展示端口
