...
(function(b, d) {
    ...
    function e(a, c) {
        for (var g = 0,
        b = c.length; g < b; g++) if (a === c[g]) return g;
        return - 1
    }
    function h(a, c) {
        if (f(a)) for (var g = 0,
    ...
    function p(a) {
        ...
        h(c,
        function(c, b) {
            a += c > 0 ? b.charAt(0).toUpperCase() + b.substr(1) : b
        });
        return a
    }
    function r(a) {
    ...
    function z(a, c) {
        ...
        h(b,
        function(a, c) {
            if (t = /^(\d+)\.\.(\d+)$/.exec(c)) for (var b = parseInt(t[1], 10); b <= parseInt(t[2], 10); b++) g[b.toString()] = !0;
            else g[c] = !0
        });
        return g
    }
    ...
    function I(a) {
        try {
            ...
            a.removeAttribute && a.removeAttribute(ma)
        }
    }
    function E(a, c, g) {
        if (c.indexOf(",") >= 0) h(c.split(","),
        function() {
            E(a, this, g)
        });
        else {
    ...
    function T(a, c, g) {
        ...
        function() {
            ...
            function(c, g) {
                ...
                var t = L[b][c];
                if (t && t.length > 0) {
                    g === d ? (C(a, c, t[0]), delete L[b][c]) : (h(t,
                    function(a, c) {
    ...
    function R(a, c, g, b) {
        ...
        if (b === d) var w = location.pathname.match(/^(\/.*)\//),
        b = w ? w[1] : "";
        var i;
        if (i = /^(\w+:\/\/[^\/]*)/.exec(a)) {
            if (i[1] !== g) return a
        } else if (/^\w+:/.test(a)) return a;
        /^\//.test(a) ? a = g + t(a.substr(1)) : /^\w+:\/\//.test(a) || (a = g + t(b + "/" + a));
    ...
    function H(a, c, g, b, d) {
        ...
        function(a, f, n, l, o, j, s) {
            ...
            if (jb[m] && !Ma[m]) if (b) {
                ...
                s = f = "\n";
                o = 0;
                for (j = n ? i.length: i.length - 1; o < j; o++) f += d,
                n || (s += d);
                l ? i.pop() : n || (s += d)
            } else f = s = "";
            if (r !== "") {
                ...
                if (m === "font") {
                    ...
                    h(p,
                    function(a, c) {
                        if (a === "color") v.color = c,
                        delete p[a];
                        a === "size" && (v["font-size"] = k[parseInt(c, 10) - 1] || "", delete p[a]);
                ...
                function(a, b) {
                    Lb[a] && (p[a] = a);
                    e(a, ["src", "href"]) >= 0 && (p[a] = R(b, g)); (c && a !== "style" && !w[m]["*"] && !w[m][a] || m === "body" && a === "contenteditable" || /^kindeditor_\d+$/.test(a)) && delete p[a];
                    if (a === "style" && b !== "") {
                        var d = M(b);
                        h(d,
                        function(a) {
    ...
    function Fa(a, c) {
        ...
        function d(a, c, g) {
            var t = []; (a = (g.ownerDocument || g).getElementById(a.replace(/\\/g, ""))) && b(c, a.nodeName) && Da(g, a) && t.push(a);
            return t
        }
        function k(a, c, g) {
            ...
            if (g.getElementsByClassName) {
                ...
                k = 0;
                for (w = d.length; k < w; k++) i = d[k],
                b(c, i.nodeName) && t.push(i)
            } else if (d.querySelectorAll) {
                d = d.querySelectorAll((g.nodeName !== "#document" ? g.nodeName + " ": "") + c + "." + a);
                k = 0;
                for (w = d.length; k < w; k++) i = d[k],
                Da(g, i) && t.push(i)
            } else {
        ...
        function w(a, c, b, d) {
            for (var t = [], b = d.getElementsByTagName(b), V = 0, k = b.length; V < k; V++) d = b[V],
            d.nodeType == 1 && (c === null ? Ea(d, a) !== null && t.push(d) : c === g(Ea(d, a)) && t.push(d));
            return t
        }
        function i(a, c) {
            var g = [],
            ...
            if (e = /#((?:[\w\-]|\\.)+)$/.exec(a)) g = d(e[1], f, c);
                ...
                if (g === "id") f = d(e, f, c);
                    ...
                    for (var Z, h = 0,
                    l = e.length; h < l; h++) Z = e[h],
                    b(f, Z.nodeName) && Da(c, Z) && Z.getAttribute("name") !== null && g.push(Z);
                    f = g
                } else f = w(g, e, f, c);
                g = f
            } else {
                ...
                Z = 0;
                for (h = f.length; Z < h; Z++) e = f[Z],
                e.nodeType == 1 && g.push(e)
            }
            return g
        }
        var f = a.split(",");
        ...
        f = [], l, o = /((?:\\.|[^\s>])+|[\s>])/g; l = o.exec(a);) l[1] !== " " && f.push(l[1]);
        l = [];
        if (f.length == 1) return i(f[0], c);
        var o = !1,
        m, s, j, r, p, v, q, B, E, u;
        v = 0;
        for (lenth = f.length; v < lenth; v++) if (m = f[v], m === ">") o = !0;
        else {
            if (v > 0) {
                s = [];
                q = 0;
                for (E = l.length; q < E; q++) {
                    ...
                    j = i(m, r);
                    B = 0;
                    for (u = j.length; B < u; B++) p = j[B],
                    o ? r === p.parentNode && s.push(p) : s.push(p)
                }
                l = s
            } else l = i(m, c);
    ...
    function Ra(a, c, g) {
        ...
        function k(d, t) {
            ...
            s; m;) {
                ...
                if (o >= 0) return ! 1;
                s = m.nextSibling;
                if (h > 0) if (m.nodeType == 1) if (l >= 0 && n <= 0) c && t.appendChild(m.cloneNode(!0)),
                g && e.push(m);
                else {
                    var j;
        ...
        if (m.nodeType == 3) return m = b(m, a.startOffset, a.endOffset),
        c && s.appendChild(m),
        d(),
        c ? s: a;
        k(m, s);
    ...
    function mb(a, c) {
        var g = a.parentElement().ownerDocument,
        b = a.duplicate();
        b.collapse(c);
        ...
        n = k.length; l < n; l++) {
            var o = k[l],
            f = h.compareEndPoints("StartToStart", b);
            if (f === 0) return {
                node: o.parentNode,
                offset: l
            };
        ...
        e -= h.text.replace(/\r\n|\n|\r/g, "").length;
        if (f > 0 && w.nodeType == 3) for (g = w.previousSibling; g && g.nodeType == 3;) e -= g.nodeValue.length,
        g = g.previousSibling;
        return {
            node: w,
            offset: e
    ...
    function nb(a, c) {
        var g = a.ownerDocument || a,
        b = g.body.createTextRange();
        if (g == a) return b.collapse(!0),
        b;
        if (a.nodeType == 1 && a.childNodes.length > 0) {
            ...
            if (!k) return b;
            if (i(k).name === "head") return c === 1 && (d = !0),
            c === 2 && (d = !1),
            b.collapse(d),
            b;
            if (k.nodeType == 1) {
                var w = i(k),
                e;
                w.isControl() && (e = g.createElement("span"), d ? w.before(e) : w.after(e), k = e);
                ua(b, k);
                b.collapse(d);
                e && i(e).remove();
                return b
    ...
    function ob(a) {
        function c(a) {
            if (i(a.node).name == "tr") a.node = a.node.cells[a.offset],
            a.offset = 0
        }
        var g;
        if (Y) {
            if (a.item) return g = ia(a.item(0)),
            g = new aa(g),
            g.selectNode(a.item(0)),
            g;
    ...
    function Xa(a) {
        ...
        b = a.clickEl || c,
        t = a.beforeDrag,
        k = [document]; (a.iframeFix === d || a.iframeFix) && i("iframe").each(function() {
        ...
        b.mousedown(function(a) {
            function d(a) {
                a.preventDefault();
                var c = i(ia(a.target)),
                t = fa((c.data("pos-x") || 0) + a.pageX - j),
                a = fa((c.data("pos-y") || 0) + a.pageY - r);
    ...
    function Rb(a, c, g, b) {
        ...
        d.push("</head><body " + (c ? 'class="' + c + '"': "") + "></body></html>");
        return d.join("\n")
    }
    function wa(a, c) {
        if (a.hasVal()) {
    ...
    function cb(a, c) {
        var g = document.getElementsByTagName("head")[0] || (da ? document.body: document.documentElement),
        b = document.createElement("script");
        g.appendChild(b);
        b.src = a;
        b.charset = "utf-8";
        b.onload = b.onreadystatechange = function() {
            if (!this.readyState || this.readyState === "loaded") c && c(),
    ...
    function db(a) {
        for (var c = document.getElementsByTagName("head")[0] || (da ? document.body: document.documentElement), g = document.createElement("link"), b = zb(R(a, "absolute")), d = i('link[rel="stylesheet"]', c), k = 0, w = d.length; k < w; k++) if (zb(R(d[k].href, "absolute")) === b) return;
        c.appendChild(g);
        g.href = a;
        g.rel = "stylesheet"
    }
        ...
        i(a.edit.doc).contextmenu(function(c) {
            ...
            if (a.useContextmenu) {
                if (a._contextmenus.length !== 0) {
                    var g = 0,
                    b = [];
                    for (h(a._contextmenus,
                    function() {
                        if (this.title == "-") b.push(this);
                        else if (this.cond && this.cond() && (b.push(this), this.width && this.width > g)) g = this.width
    ...
    function Tb() {
        ...
        if (! (F && b !== "br") && (!la || !(N < 3 && b !== "p")) && !(Qa && N < 9)) {
            ...
            i(g).keydown(function(i) {
                if (! (i.which != 13 || i.shiftKey || i.ctrlKey || i.altKey)) {
                    c.cmd.selection();
                    var e = a(c.cmd.range);
            ...
            i(g).keyup(function(d) {
                if (! (d.which != 13 || d.shiftKey || d.ctrlKey || d.altKey) && b != "br") if (la) {
                    ...
                    t = c.cmd.commonAncestor("a");
                    t && t.text() == "" && (t.remove(!0), c.cmd.range.selectNodeContents(d[0]).collapse(!0), c.cmd.select())
                } else if (c.cmd.selection(), d = a(c.cmd.range), !(d == "marquee" || d == "select")) if (k[d] || ea(g, "formatblock", "<p>"), d = c.cmd.commonAncestor("div")) {
    ...
    function Ub() {
        ...
        i(c).keydown(function(g) {
            if (g.which == 9) if (g.preventDefault(), a.afterTab) a.afterTab.call(a, g);
            else {
                var g = a.cmd,
                b = g.range;
                b.shrink();
    ...
    function Eb(a, c) {
        ...
        g.designMode ? (d = this.cmd.range, k = d.createBookmark(!0), k.html = b.innerHTML) : k = {
            html: b.innerHTML
        };
        Db(c, k);
        var e = a.pop();
    ...
    function Fb(a, c) {
        ...
        if ((b = i(a)) && b.length !== 0) {
            ...
            cb(d.langPath + d.langType + ".js?ver=" + encodeURIComponent(i.DEBUG ? Ja: Ka),
            function() {
                g(d)
            });
            return d
    ...
    function Ca(a, c) {
        i(a).each(function(a, b) {
            i.each(_instances,
            function(a, g) {
                if (g && g.srcElement[0] == b) return c.call(g, a),
                !1
            })
        })
    }
    if (!b.KindEditor) {
        ...
        var Ka = "4.1.10 (2013-11-23)",
        J = navigator.userAgent.toLowerCase(),
        F = J.indexOf("msie") > -1 && J.indexOf("opera") == -1,
        Pb = J.indexOf("msie") == -1 && J.indexOf("trident") > -1,
        la = J.indexOf("gecko") > -1 && J.indexOf("khtml") == -1,
        ka = J.indexOf("applewebkit") > -1,
        Qa = J.indexOf("opera") > -1,
        Wb = J.indexOf("mobile") > -1,
        Xb = /ipad|iphone|ipod/.test(J),
        da = document.compatMode != "CSS1Compat",
        Y = !b.getSelection,
        ...
        ib = z("a,abbr,acronym,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,img,input,ins,kbd,label,map,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"),
        jb = z("address,applet,blockquote,body,center,dd,dir,div,dl,dt,fieldset,form,frameset,h1,h2,h3,h4,h5,h6,head,hr,html,iframe,ins,isindex,li,map,menu,meta,noframes,noscript,object,ol,p,pre,script,style,table,tbody,td,tfoot,th,thead,title,tr,ul"),
        hb = z("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"),
        Gb = z("b,basefont,big,del,em,font,i,s,small,span,strike,strong,sub,sup,u"),
        Yb = z("img,table,input,textarea,button"),
        Ma = z("pre,style,script"),
        La = z("html,head,body,td,tr,table,ol,ul,li");
        z("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr");
        var Lb = z("checked,compact,declare,defer,disabled,ismap,multiple,nohref,noresize,noshade,nowrap,readonly,selected"),
        Hb = z("input,button,textarea,select");
        i.basePath = function() {
            for (var a = document.getElementsByTagName("script"), c, g = 0, b = a.length; g < b; g++) if (c = a[g].src || "", /kindeditor[\w\-\.]*\.js/.test(c)) return c.substring(0, c.lastIndexOf("/") + 1);
            return ""
        } ();
        i.options = {
            designMode: !0,
            ...
            htmlTags: {
                ...
                img: ["id", "class", "src", "width", "height", "border", "alt", "title", "align", ".width", ".height", ".border", ".margin", ".padding", ".float"],
        ...
        var fb = !1,
        Ib = z("8,9,13,32,46,48..57,59,61,65..90,106,109..111,188,190..192,219..222"),
        J = z("33..40"),
        eb = {};
        h(Ib,
        function(a, c) {
        ...
        var ma = "kindeditor_" + Ja,
        gb = 0,
        L = {},
        Jb = !1;
        F && b.attachEvent("onunload",
        function() {
            h(L,
            function(a, c) {
                c.el && T(c.el)
        ...
        i.ready = function(a) {
            ...
            if (Jb) a(KindEditor);
                ...
                var t = !1;
                if (document.addEventListener) E(document, "DOMContentLoaded", c);
        ...
        i.clearMsWord = U;
        i.tmpl = function(a, c) {
            var g = new Function("obj", "var p=[],print=function(){p.push.apply(p,arguments);};with(obj){p.push('" + a.replace(/[\r\t\n]/g, " ").split("<%").join("\t").replace(/((^|%>)[^\t]*)'/g, "$1\r").replace(/\t=(.*?)%>/g, "',$1,'").split("\t").join("');").split("%>").join("p.push('").split("\r").join("\\'") + "');}return p.join('');");
            return c ? g(c) : g
        };
        ...
        A(P, {
            init: function(a) {
                for (var a = f(a) ? a: [a], c = 0, g = 0, b = a.length; g < b; g++) a[g] && (this[g] = a[g].constructor === P ? a[g][0] : a[g], c++);
                this.length = c;
                this.doc = ia(this[0]);
                this.name = Pa(this[0]);
            ...
            attr: function(a, c) {
                ...
                if (typeof a === "object") return h(a,
                function(a, c) {
                    g.attr(a, c)
                }),
                g;
                if (c === d) return c = g.length < 1 ? null: Ea(g[0], a),
                c === null ? "": c;
                g.each(function() {
                    Oa(this, a, c)
                });
            ...
            eq: function(a) {
                if (this.length < 1) return null;
                return this[a] ? new P(this[a]) : null
            },
            hasClass: function(a) {
                if (this.length < 1) return ! 1;
            ...
            append: function(a) {
                this.each(function() {
                    this.appendChild && this.appendChild(i(a)[0])
                });
                return this
            },
            appendTo: function(a) {
            ...
            children: function() {
                if (this.length < 1) return new P([]);
                for (var a = [], c = this[0].firstChild; c;)(c.nodeType != 3 || m(c.nodeValue) !== "") && a.push(c),
                c = c.nextSibling;
                return new P(a)
            },
            first: function() {
            ...
            scan: function(a, c) {
                ...
                if (! (this.length < 1)) return c = c === d ? !0 : c,
                b(this[0]),
                this
            }
        });
        ...
        A(aa, {
            ...
            commonAncestor: function() {
                function a(a) {
                    for (var c = []; a;) c.push(a),
                    a = a.parentNode;
                    return c
                }
                for (var c = a(this.startContainer), b = a(this.endContainer), d = 0, i = c.length, k = b.length, e, f; ++d;) if (e = c[i - d], f = b[k - d], !e || !f || e !== f) break;
                return c[i - d + 1]
            },
            setStart: function(a, c) {
                ...
                this.startContainer = a;
                this.startOffset = c;
                if (this.endContainer === b) this.endContainer = a,
                this.endOffset = c;
                return lb(this)
            },
            setEnd: function(a, c) {
                ...
                this.endContainer = a;
                this.endOffset = c;
                if (this.startContainer === b) this.startContainer = a,
                this.startOffset = c;
                return lb(this)
            },
            setStartBefore: function(a) {
                return this.setStart(a.parentNode || this.doc, i(a).index())
            },
            ...
            selectNodeContents: function(a) {
                ...
                c = c.children();
                if (c.length > 0) return this.setStartBefore(c[0]).setEndAfter(c[c.length - 1]);
            ...
            compareBoundaryPoints: function(a, c) {
                ...
                if (Y) {
                    ...
                    if (b !== 0) return b;
                    var k, e, f, h;
                    if (a === sa || a === ta) k = this.startContainer,
                    f = this.startOffset;
                    if (a === ra || a === oa) k = this.endContainer,
                    f = this.endOffset;
                    if (a === sa || a === ra) e = c.startContainer,
                    h = c.startOffset;
                    if (a === oa || a === ta) e = c.endContainer,
                    h = c.endOffset;
                    if (k === e) return k = f - h,
                    k > 0 ? 1 : k < 0 ? -1 : 0;
            ...
            cloneRange: function() {
                return (new aa(this.doc)).setStart(this.startContainer, this.startOffset).setEnd(this.endContainer, this.endOffset)
            },
            toString: function() {
                var a = this.get();
            ...
            get: function(a) {
                ...
                if (a && this.isControl()) return c = c.body.createControlRange(),
                c.addElement(this.startContainer.childNodes[this.startOffset]),
                c;
            ...
            createBookmark: function(a) {
                ...
                if (!this.collapsed) c = b.cloneNode(!0),
                c.id = "__kindeditor_bookmark_end_" + Kb+++"__";
        ...
        A(va, {
            ...
            selection: function(a) {
                ...
                this.sel = Ta(c);
                if (b) return this.range = Sa(b),
                i(this.range.startContainer).name == "html" && this.range.selectNodeContents(c.body).collapse(!1),
                this;
            ...
            select: function(a) {
                ...
                if (Y) try {
                    h = b.get(!0),
                    h.select()
                } catch(o) {} else l && b.collapse(!1),
                h = b.get(!0),
                c.removeAllRanges(),
                c.addRange(h),
                k !== document && (b = i(h.endContainer).pos(), f.scrollTo(b.x, b.y));
                f.focus();
                return this
            },
            wrap: function(a) {
                ...
                b;
                b = i(a, this.doc);
                if (c.collapsed) return c.shrink(),
                c.insertNode(b[0]).selectNodeContents(b[0]),
                this;
                if (b.isBlock()) {
                ...
                i(a).scan(function(a) {
                    if (!k && a == e.start) k = !0;
                        ...
                        if (!d && c.type == 3 && m(a.nodeValue).length > 0) {
                            ...
                            f = b;
                            f = f.clone(!0);
                            if (c.type == 3) Wa(f).append(c.clone(!1)),
                            c.replaceWith(f);
                            else {
                                for (var a = c,
                                h; (h = c.first()) && h.children().length == 1;) c = h;
                                h = c.first();
                                ...
                                for (var l = h,
                                n = !1; f;) {
                                    for (; l;) l.name === f.name && (Qb(l, f.attr(), f.css()), n = !0),
                                    l = l.first();
            ...
            split: function(a, c) {
                for (var b = this.range,
                d = b.doc,
                e = b.cloneRange().collapse(a), k = e.startContainer, f = e.startOffset, h = k.nodeType == 3 ? k.parentNode: k, l = !1, n; h && h.parentNode;) {
                    n = i(h);
                    if (c) {
                        if (!n.isStyle()) break;
                        if (!Ua(n, c)) break
                ...
                if (l) d = d.createElement("span"),
                b.cloneRange().collapse(!a).insertNode(d),
                a ? e.setStartBefore(h.firstChild).setEnd(k, f) : e.setStart(k, f).setEndAfter(h.lastChild),
                k = e.extractContents(),
                f = k.firstChild,
                l = k.lastChild,
                a ? (e.insertNode(k), b.setStartAfter(l).setEndBefore(d)) : (h.appendChild(k), b.setStartBefore(d).setEndBefore(f)),
                e = d.parentNode,
                e == b.endContainer && (h = i(d).prev(), k = i(d).next(), h && k && h.type == 3 && k.type == 3 ? b.setEnd(h[0], h[0].nodeValue.length) : a || b.setEnd(b.endContainer, b.endOffset - 1)),
                e.removeChild(d);
                return this
            },
            remove: function(a) {
                ...
                if (b.startOffset === 0) {
                    ...
                    d.isBlock() && Va(d, a); (d = d.parent()) && d.isBlock() && Va(d, a)
                }
                if (b.collapsed) {
                    this.split(!0, a);
                    c = b.startContainer;
                    d = b.startOffset;
                    if (d > 0 && (e = i(c.childNodes[d - 1])) && pa(e)) e.remove(),
                    b.setStart(c, d - 1); (d = i(c.childNodes[d])) && pa(d) && d.remove();
                    pa(c) && (b.startBefore(c), c.remove());
                    b.collapse(!0);
                    return this
                }
                this.split(!0, a);
                ...
                if (d > 0) {
                    ...
                    m && pa(m) && (m.remove(), b.setStart(c, d - 1), c == e && b.setEnd(e, o - 1));
                    if ((d = i(c.childNodes[d])) && pa(d)) d.remove(),
                    c == e && b.setEnd(e, o - 1)
            ...
            commonNode: function(a) {
                ...
                k = c(e);
                if (k) return k;
                if (e.nodeType == 1 || d.nodeType == 3 && b === 0) if (d = i(e).prev()) return c(d);
                return null
            },
            ...
            val: function(a) {
                ...
                a = a.toLowerCase(),
                b = "";
                if (a === "fontfamily" || a === "fontname") return b = pb(c, "fontname"),
                b = b.replace(/['"]/g, ""),
                b.toLowerCase();
                if (a === "formatblock") {
                    b = pb(c, a);
            ...
            inserthtml: function(a, c) {
                function b(a, c) {
                    var c = '<img id="__kindeditor_temp_tag__" width="0" height="0" style="display:none;" />' + c,
                    d = a.get();
            ...
            createlink: function(a, c) {
                ...
                e = this.range;
                this.select();
                var k = this.commonNode({
                    a: "*"
                });
                k && !e.isControl() && (e.selectNode(k.get()), this.select());
                k = '<a href="' + s(a) + '" data-ke-src="' + s(a) + '" ';
                c && (k += ' target="' + s(c) + '"');
                if (e.collapsed) return k += ">" + s(a) + "</a>",
                this.inserthtml(k);
                if (e.isControl()) {
                ...
                h = e.endContainer,
                e = e.endOffset;
                if (k.nodeType == 1 && k === h && f + 1 === e && (e = k.childNodes[f], e.nodeName.toLowerCase() == "a")) return b(e, a, c),
                this;
                ea(d, "createlink", "__kindeditor_temp_url__");
                i('a[href="__kindeditor_temp_url__"]', d).each(function() {
                    b(this, a, c)
                });
                return this
            },
        ...
        function(a, c) {
            va.prototype[c] = function(a) {
                this.select();
                ea(this.doc, c, a);
                Y && e(c, "justifyleft,justifycenter,justifyright,justifyfull".split(",")) >= 0 && this.selection(); (!Y || e(c, "formatblock,selectall,insertorderedlist,insertunorderedlist".split(",")) >= 0) && this.selection();
                return this
            }
        });
        ...
        A(ga, {
            ...
            autoPos: function(a, c) {
                ...
                e = na();
                if (this._alignEl) {
                    var k = i(this._alignEl),
                    f = k.pos(),
                    b = fa(k[0].clientWidth / 2 - b / 2),
                    d = fa(k[0].clientHeight / 2 - d / 2);
                    x = b < 0 ? f.x: f.x + b;
                    y = d < 0 ? f.y: f.y + d
                } else f = X(this.doc),
                x = fa(e.x + (f.clientWidth - b) / 2),
                y = fa(e.y + (f.clientHeight - d) / 2);
                F && N < 7 || da || (x -= e.x, y -= e.y);
                return this.pos(x, y)
            },
            remove: function() {
                var a = this; (F && N < 7 || da) && i(a.win).unbind("scroll");
                a.div.remove();
                h(a,
                function(c) {
                    a[c] = null
        ...
        A(xa, ga, {
            init: function(a) {
                function c() {
                    ...
                    ka && i(c).click(function(a) {
                        i(a.target).name === "img" && (l.selection(!0), l.range.selectNode(a.target), l.select())
                    });
                    ...
                    i(document).mousedown(b._mousedownHandler),
                    i(c).keydown(function(a) {
                        if (a.which == 8) {
                            l.selection();
                            var c = l.range;
                ...
                var d = q(a.themesPath, ""),
                e = a.bodyClass,
                k = a.cssPath,
                f = a.cssData,
                h = location.protocol != "res:" && location.host.replace(/:\d+/, "") !== document.domain,
                l = "document.open();" + (h ? 'document.domain="' + document.domain + '";': "") + "document.close();",
                l = F ? ' src="javascript:void(function(){' + encodeURIComponent(l) + '}())"': "";
            ...
            html: function(a, c) {
                ...
                if (this.designMode) {
                    b = b.body;
                    if (a === d) return a = c ? "<!doctype html><html>" + b.parentNode.innerHTML + "</html>": b.innerHTML,
                    this.beforeGetHtml && (a = this.beforeGetHtml(a)),
                    la && a == "<br />" && (a = ""),
                    a;
                    this.beforeSetHtml && (a = this.beforeSetHtml(a));
                    F && N >= 9 && (a = a.replace(/(<.*?checked=")checked(".*>)/ig, "$1$2"));
                    i(b).html(a);
            ...
            afterChange: function(a) {
                ...
                var b = this.doc,
                d = b.body;
                i(b).keyup(function(c) { ! c.ctrlKey && !c.altKey && eb[c.which] && a(c)
                });
        ...
        A(Ga, ga, {
            ...
            disableAll: function(a, c) {
                var b = this,
                e = b.noDisableItemMap;
                c && (e = z(c)); (a === d ? !b.disableMode: a) ? (i("span.ke-outline", b.div).each(function() {
                    var a = i(this),
                    c = a[0].getAttribute("data-name", 2);
                    e[c] || b.disable(a)
        ...
        A(ya, ga, {
            ...
            addItem: function(a) {
                if (a.title === "-") this.div.append(i('<div class="ke-menu-separator"></div>'));
                    ...
                    b = i('<div class="ke-inline-block ke-menu-item-left"></div>'),
                    d = i('<div class="ke-inline-block ke-menu-item-right"></div>'),
                    e = o(a.height),
                    f = q(a.iconClass, "");
                    this.div.append(c);
        ...
        A(za, ga, {
            init: function(a) {
                ...
                for (var e = 0; e < c.length; e++) for (var b = a.insertRow(e + 1), i = 0; i < c[e].length; i++) d = b.insertCell(i),
                this._addAttr(d, c[e][i], "ke-colorpicker-cell")
            },
        ...
        A(bb, {
            init: function(a) {
                ...
                f = a.extraParams || {},
                h = c[0].className || "",
                l = a.target || "kindeditor_upload_iframe_" + (new Date).getTime();
                ...
                b = ['<div class="ke-inline-block ' + h + '">', a.target ? "": '<iframe name="' + l + '" style="display:none;"></iframe>', a.form ? '<div class="ke-upload-area">': '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + l + '" action="' + d + '">', '<span class="ke-button-common">', n.join(""), '<input type="button" class="ke-button-common ke-button" value="' + e + '" />', "</span>", '<input type="file" class="ke-upload-file" name="' + b + '" tabindex="-1" />', a.form ? "</div>": "</form>", "</div>"].join("");
                b = i(b, c.doc);
                c.hide();
                c.before(b);
                this.div = b;
            ...
            submit: function() {
                ...
                function() {
                    ...
                    i(b).remove(!0);
                    var b = i.iframeDoc(c),
                    d = b.getElementsByTagName("pre")[0],
                    e = "",
                    f,
                    e = d ? d.innerHTML: b.body.innerHTML,
                    e = v(e);
                    ...
                    f && a.options.afterUpload.call(a, f)
                });
                a.form[0].submit();
                return a
            },
        ...
        A(Aa, ga, {
            init: function(a) {
                ...
                s.append(a);
                a.append(d);
                var j = i('<div class="ke-dialog-footer"></div>'); (e || f || n) && s.append(j);
                h([{
                    btn: e,
                    name: "preview"
                },
                ...
                function() {
                    if (this.btn) {
                        ...
                        a = a || {},
                        c = a.name || "",
                        b = i('<span class="ke-button-common ke-button-outer" title="' + c + '"></span>'),
                        c = i('<input class="ke-button-common ke-button" type="button" value="' + c + '" />');
        ...
        i.ajax = function(a, c, d, e, i) {
            ...
            if (d == "POST") {
                ...
                h(e,
                function(a, c) {
                    l.push(encodeURIComponent(a) + "=" + encodeURIComponent(c))
                });
                try {
        ...
        Ba.prototype = {
            ...
            loadPlugin: function(a, c) {
                ...
                ba[a] = "loading";
                cb(b.pluginsPath + a + "/" + a + ".js?ver=" + encodeURIComponent(i.DEBUG ? Ja: Ka),
                function() {
                    setTimeout(function() {
                        ba[a] && b.loadPlugin(a, c)
                    },
                    0)
                });
                return b
            ...
            handler: function(a, c) {
                ...
                if (j(c)) return b._handlers[a].push(c),
                b;
                h(b._handlers[a],
                function() {
                    c = this.call(b, c)
            ...
            create: function() {
                function a() {
                    m.height() === 0 ? setTimeout(a, 100) : c.resize(e, f, !1)
                }
                var c = this,
                d = c.fullscreenMode;
                ...
                f = d ? X().clientHeight + "px": c.height;
                ...
                k.removeClass("container").addClass("ke-container ke-container-" + c.themeType).css("width", e);
                if (d) {
                    k.css({
                        position: "absolute",
                        left: 0,
                    ...
                    height: "",
                    overflow: ""
                }), i(document.body.parentNode).css("overflow", "")),
                c._scrollPos && b.scrollTo(c._scrollPos.x, c._scrollPos.y);
                var s = [];
                i.each(c.items,
                function(a, b) {
                    b == "|" ? s.push('<span class="ke-inline-block ke-separator"></span>') : b == "/" ? s.push('<div class="ke-hr"></div>') : (s.push('<span class="ke-outline" data-name="' + b + '" title="' + c.lang(b) + '" unselectable="on">'), s.push('<span class="ke-toolbar-icon ke-toolbar-icon-url ke-icon-' + b + '" unselectable="on"></span></span>'))
                });
                var h = c.toolbar = wb({
                    src: h,
                    html: s.join(""),
                ...
                r = c.edit = ub({
                    ...
                    afterCreate: function() {
                        ...
                        r.textarea.keyup(function(a) { ! a.ctrlKey && !a.altKey && Ib[a.which] && c.options.afterChange && c.options.afterChange.call(c)
                        });
                        ...
                        if (c._undoStack.length > 0) {
                            ...
                            a.start && (c.html(a.html), r.cmd.range.moveToBookmark(a), c.select())
                        }
                        c.afterCreate();
                ...
                if (c._fullscreenResizeHandler) i(b).unbind("resize", c._fullscreenResizeHandler),
                c._fullscreenResizeHandler = null;
                a();
                d ? (c._fullscreenResizeHandler = function() {
                    c.isCreated && c.resize(X().clientWidth, X().clientHeight, !1)
                },
                i(b).bind("resize", c._fullscreenResizeHandler), h.select("fullscreen"), m.first().css("visibility", "hidden"), m.last().css("visibility", "hidden")) : (la && i(b).bind("scroll",
                function() {
                    c._scrollPos = na()
                }), c.resizeType > 0 ? Xa({
                    moveEl: k,
            ...
            resize: function(a, c, b) {
                b = q(b, !0);
                if (a && (/%/.test(a) || (a = l(a), a = a < this.minWidth ? this.minWidth: a), this.container.css("width", o(a)), b)) this.width = o(a);
            ...
            addBookmark: function(a) {
                ...
                b = c.doc.body,
                d = Ia(b.innerHTML);
                if (a && this._undoStack.length > 0 && Math.abs(d.length - ha(this._undoStack[this._undoStack.length - 1].html).length) < this.minChangeSize) return this;
                c.designMode && !this._firstAddBookmark ? (c = this.cmd.range, a = c.createBookmark(!0), a.html = Ia(b.innerHTML), c.moveToBookmark(a)) : a = {
                    html: d
                };
            ...
            readonly: function(a) {
                ...
                b = c.edit,
                d = b.doc;
                c.designMode ? c.toolbar.disableAll(a, []) : h(c.noDisableItems,
                function() {
            ...
            createMenu: function(a) {
                var c = this.toolbar.get(a.name),
                b = c.pos();
                a.x = b.x;
                a.y = b.y + c.height();
                a.z = this.options.zIndex;
                a.shadowMode = q(a.shadowMode, this.shadowMode);
                a.selectedColor !== d ? (a.cls = "ke-colorpicker-" + this.themeType, a.noColor = this.lang("noColor"), this.menu = xb(a)) : (a.cls = "ke-menu-" + this.themeType, a.centerLineMode = !1, this.menu = ab(a));
                return this.menu
            },
            hideMenu: function() {
                this.menu.remove();
        ...
        function(a) {
            ...
            c.clickToolbar("source",
            function() {
                c.edit.designMode ? (c.toolbar.disableAll(!0), c.edit.design(!1), c.toolbar.select("source")) : (c.toolbar.disableAll(!1), c.edit.design(!0), c.toolbar.unselect("source"), la ? setTimeout(function() {
                    c.cmd.selection()
                },
                0) : c.cmd.selection());
            ...
            function() {
                ...
                function(a, e) {
                    ...
                    g.addItem({
                        title: '<span style="' + f + '" unselectable="on">' + e + "</span>",
                        height: b[a] + 12,
                        checked: d === a || d === e,
                        click: function() {
            ...
            h("link,image,flash,media,anchor".split(","),
            function(a, b) {
                var g = b.charAt(0).toUpperCase() + b.substr(1);
                h("edit,delete".split(","),
                function(a, e) {
                    c.addContextmenu({
                        title: c.lang(e + g),
                        ...
                        cond: c.plugin["getSelected" + g],
                        width: 150,
                        iconClass: e == "edit" ? "ke-icon-" + b: d
                    })
                });
                c.addContextmenu({
                    title: "-"
            ...
            h("selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript,hr,print,bold,italic,underline,strikethrough,removeformat,appremoveformat,unlink".split(","),
            function(a, b) {
                g[b] && c.afterCreate(function() {
                    $(this.edit.doc, g[b],
                    function() {
            ...
            c.afterCreate(function() {
                ...
                var d = c.edit.doc,
                g, e, f, i = "__kindeditor_paste__",
                h = !1;
                a(d.body).bind("paste",
                function(l) {
                    if (c.pasteType === 0) l.stop();
                    else if (!h) {
                        h = !0;
                        a("div." + i, d).remove();
                        g = c.cmd.selection();
                        ...
                        if (F) {
                            ...
                            n.execCommand("paste");
                            l.preventDefault()
                        } else g.range.selectNodeContents(f[0]),
                        g.select();
                        setTimeout(function() {
                            b();
                            h = !1
            ...
            c.beforeGetHtml(function(a) {
                F && N <= 8 && (a = a.replace(/<div\s+[^>]*data-ke-input-tag="([^"]*)"[^>]*>([\s\S]*?)<\/div>/ig,
                function(a, b) {
                    return unescape(b)
            ...
            c.beforeSetHtml(function(a) {
                F && N <= 8 && (a = a.replace(/<input[^>]*>|<(select|button)[^>]*>[\s\S]*?<\/\1>/ig,
                function(a) {
                    var b = K(a);
                ...
                function(a) {
                    ...
                    return kb(c.themesPath + "common/blank.gif", a)
                }).replace(/<a[^>]*name="([^"]+)"[^>]*>(?:<\/a>)?/ig,
                function(a) {
                    var b = K(a);
...
"zh_CN");
KindEditor.plugin("anchor",
function(b) {
    var d = this,
    f = d.lang("anchor.");
    d.plugin.anchor = {
        edit: function() {
            var j = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keName">' + f.name + "</label>", '<input class="ke-input-text" type="text" id="keName" name="name" value="" style="width:100px;" /></div></div>'].join(""),
            j = d.createDialog({
                name: "anchor",
                width: 300,
                title: d.lang("anchor"),
            ...
            e = b('input[name="name"]', j); (j = d.plugin.getSelectedAnchor()) && e.val(unescape(j.attr("data-ke-name")));
            e[0].focus();
            e[0].select()
        },
        "delete": function() {
...
function(b) {
    ...
    function() {
        ...
        m = d.createDialog({
            ...
            yesBtn: {
                ...
                click: function() {
                    ...
                    f = f.lng + "," + f.lat,
                    b = b.getZoom(),
                    b = [s[0].checked ? d.pluginsPath + "baidumap/index.html": "http://api.map.baidu.com/staticimage", "?center=" + encodeURIComponent(f), "&zoom=" + encodeURIComponent(b), "&width=" + j, "&height=" + e, "&markers=" + encodeURIComponent(f), "&markerStyles=" + encodeURIComponent("l,A")].join("");
        ...
        n = m.div,
        o = b('[name="address"]', n),
        l = b('[name="searchBtn"]', n),
        s = b('[name="insertDynamicMap"]', m.div),
        v,
        p,
        r = b('<iframe class="ke-textarea" frameborder="0" src="' + d.pluginsPath + 'baidumap/map.html" style="width:' + j + "px;height:" + e + 'px;"></iframe>');
        r.bind("load",
        function() {
            r.unbind("load");
...
function(b) {
    var d = this;
    d.clickToolbar("clearhtml",
    function() {
        d.focus();
        var f = d.html(),
        f = f.replace(/(<script[^>]*>)([\s\S]*?)(<\/script>)/ig, ""),
    ...
    function() {
        ...
        j = d.createDialog({
            ...
            yesBtn: {
                name: d.lang("yes"),
                click: function() {
                    var h = b(".ke-code-type", j.div).val(),
                    m = e.val(),
                    h = '<pre class="prettyprint' + (h === "" ? "": " lang-" + h) + '">\n' + b.escape(m) + "</pre> ";
...
KindEditor.plugin("emoticons",
function(b) {
    var d = this,
    f = d.emoticonsPath || d.pluginsPath + "emoticons/images/",
    j = d.allowPreviewEmoticons === void 0 ? !0 : d.allowPreviewEmoticons,
    e = 1;
    d.clickToolbar("emoticons",
    function() {
        function h(e, h, l) {
            ...
            e.click(function(b) {
                d.insertHtml('<img src="' + f + l + '.gif" border="0" alt="" />').hideMenu().focus();
                b.stop()
            })
        }
        function m(d, e) {
            ...
            for (var n = (d - 1) * r + p, o = 0; o < s; o++) for (var m = l.insertRow(o), j = 0; j < v; j++) {
                ...
                q.addClass("ke-cell");
                h(q, j, n);
                var u = b('<span class="ke-img"></span>').css("background-position", "-" + 24 * n + "px 0px").css("background-image", "url(" + f + "static.gif)");
                q.append(u);
                A.push(q);
                n++
            }
        ...
        z = Math.ceil(135 / r),
        D = Math.floor(v / 2),
        q = b('<div class="ke-plugin-emoticons"></div>'),
        A = [];
        d.createMenu({
            name: "emoticons",
            beforeRemove: function() {
...
function(b) {
    ...
    f.plugin.filemanagerDialog = function(m) {
        ...
        function o(d, e, f, h) {
            var l = b.formatUrl(e.current_url + f.filename, "absolute"),
            o = encodeURIComponent(e.current_dir_path + f.filename + "/");
        ...
        function s(d) {
            ...
            j = n.length; m < j; m++) {
                ...
                var q = b('<img src="' + (e + (r.is_dir ? "folder-16.gif": "file-16.gif")) + '" width="16" height="16" alt="' + r.filename + '" align="absmiddle" />'),
                q = b(p[0].insertCell(0)).addClass("ke-cell ke-name").append(q).append(document.createTextNode(" " + r.filename)); ! r.is_dir || r.has_file ? (p.css("cursor", "pointer"), q.attr("title", r.filename), o(q, d, r, s)) : q.attr("title", h.emptyFolder);
...
function(b) {
	var upload_php=LQ.EDITOR;
	upload_php=upload_php.replace(/##/,$("#my_controller_name").val());
	upload_php=upload_php.replace(/###/,$("#LQForm").attr("uid"));
	upload_php=upload_php.replace(/####/,$("#LQForm").attr("token"));
    var d = this,
    f = b.undef(d.allowImageUpload, !0),
    j = b.undef(d.allowImageRemote, !0),
    e = b.undef(d.formatUploadUrl, !0),
    h = b.undef(d.allowFileManager, !1),
    m = b.undef(d.uploadJson,upload_php),
    n = b.undef(d.imageTabIndex, 0),
    o = d.pluginsPath + "image/images/",
    l = b.undef(d.extraFileUploadParams, {}),
    s = b.undef(d.filePostName, "imgFile"),
    v = b.undef(d.fillDescAfterUploadImage, !1),
    p = d.lang("image.");
    d.plugin.imageDialog = function(f) {
        ...
        I = d.createDialog({
            ...
            yesBtn: {
                name: d.lang("yes"),
                click: function() {
                    if (!I.isLoading) if (q && j && H && H.selectedIndex === 1 || !j) U.fileBox.val() == "" ? alert(d.lang("pleaseSelectFile")) : (I.showLoading(d.lang("uploadLoading")), U.submit(), qa.val(""));
                    else {
                        var e = b.trim(T.val()),
                        f = M.val(),
                        h = K.val(),
                        ...
                        n = "";
                        R.each(function() {
                            if (this.checked) return n = this.value,
                            !1
                        });
                        e == "http://" || b.invalidUrl(e) ? (alert(d.lang("invalidUrl")), T[0].focus()) : /^\d*$/.test(f) ? /^\d*$/.test(h) ? B.call(d, e, l, f, h, 0, n) : (alert(d.lang("invalidHeight")), K[0].focus()) : (alert(d.lang("invalidWidth")), M[0].focus())
                    }
                }
            },
            beforeRemove: function() {
        ...
        E = I.div,
        T = b('[name="url"]', E),
        qa = b('[name="localUrl"]', E),
        $ = b('[name="viewServer"]', E),
        M = b('.tab1 [name="width"]', E),
        K = b('.tab1 [name="height"]', E),
        O = b(".ke-refresh-btn", E),
        Q = b('.tab1 [name="title"]', E),
        R = b('.tab1 [name="align"]', E),
        H;
        j && q ? (H = b.tabs({
            src: b(".tabs", E),
        ...
        var U = b.uploadbutton({
            ...
            afterUpload: function(f) {
                ...
                if (f.error === 0) {
                    ...
                    v ? (b(".ke-dialog-row #remoteUrl", E).val(h), b(".ke-tabs-li", E)[0].click(), b(".ke-refresh-btn", E).click()) : B.call(d, h, f.title, f.width, f.height, f.border, f.align)
        ...
        Q.val(f.imageTitle);
        R.each(function() {
            if (this.value === f.imageAlign) return this.checked = !0,
            !1
        });
...
function(b) {
    var d = this,
    f = b.undef(d.allowFileUpload, !0),
    j = b.undef(d.allowFileManager, !1),
    e = b.undef(d.formatUploadUrl, !0),
    h = b.undef(d.uploadJson,''),
    m = b.undef(d.extraFileUploadParams, {}),
    n = b.undef(d.filePostName, "imgFile"),
    o = d.lang("insertfile.");
    d.plugin.fileDialog = function(l) {
        var s = b.undef(l.fileUrl, "http://"),
        v = b.undef(l.fileTitle, ""),
        p = l.clickFn,
        l = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + o.url + "</label>", '<input type="text" id="keUrl" name="url" class="ke-input-text" style="width:160px;" /> &nbsp;', '<input type="button" class="ke-upload-button" value="' + o.upload + '" /> &nbsp;', '<span class="ke-button-common ke-button-outer">', '', '</span></div><div class="ke-dialog-row">', '<label for="keTitle" style="width:60px;">' + o.title + "</label>", '<input type="text" id="keTitle" class="ke-input-text" name="title" value="" style="width:160px;" /></div></div></form></div>'].join(""),
        r = d.createDialog({
            name: "insertfile",
            width: 450,
        ...
        j ? l.click(function() {
            ...
            function() {
                d.plugin.filemanagerDialog({
                    ...
                    dirName: "file",
                    clickFn: function(e) {
                        d.dialogs.length > 1 && (b('[name="url"]', z).val(e), d.afterSelectFile && d.afterSelectFile.call(d, e), d.hideDialog())
                    }
                })
            })
        }) : l.hide();
...
KindEditor.plugin("lineheight",
function(b) {
    var d = this,
    f = d.lang("lineheight.");
    d.clickToolbar("lineheight",
    function() {
        var j = "",
        e = d.cmd.commonNode({
            "*": ".line-height"
        ...
        function(e, f) {
            ...
            function(b, e) {
                h.addItem({
                    ...
                    checked: j === b,
                    click: function() {
                        d.cmd.toggle('<span style="line-height:' + b + ';"></span>', {
                            span: ".line-height=" + b
                        });
                        d.updateState();
                        d.addBookmark();
...
function(b) {
    ...
    d.plugin.link = {
        edit: function() {
            var f = d.lang("link."),
            j = '<div style="padding:20px;"><div class="ke-dialog-row"><label for="keUrl" style="width:60px;">' + f.url + '</label><input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:260px;" /></div><div class="ke-dialog-row""><label for="keType" style="width:60px;">' + f.linkType + '</label><select id="keType" name="type"></select></div></div>',
            j = d.createDialog({
                name: "link",
                width: 450,
                title: d.lang("link"),
            ...
            e = b('input[name="url"]', j),
            h = b('select[name="type"]', j);
            e.val("http://");
            h[0].options[0] = new Option(f.newWindow, "_blank");
            h[0].options[1] = new Option(f.selfWindow, "");
            d.cmd.selection();
            if (f = d.plugin.getSelectedLink()) d.cmd.range.selectNode(f[0]),
            d.cmd.select(),
            e.val(f.attr("data-ke-src")),
            h.val(f.attr("target"));
            e[0].focus();
            e[0].select()
        },
    ...
    function() {
        ...
        e = d.createDialog({
            ...
            yesBtn: {
                ...
                click: function() {
                    var b = n.map,
                    e = b.getCenter().lat() + "," + b.getCenter().lng(),
                    f = b.getZoom(),
                    b = b.getMapTypeId(),
...
KindEditor.plugin("media",
function(b) {
    var d = this,
    f = d.lang("media."),
    j = b.undef(d.allowMediaUpload, !0),
    e = b.undef(d.allowFileManager, !1),
    h = b.undef(d.formatUploadUrl, !0),
    m = b.undef(d.extraFileUploadParams, {}),
    n = b.undef(d.filePostName, "imgFile"),
    o = b.undef(d.uploadJson,'');
    d.plugin.media = {
        edit: function() {
    ...
    b.extend(d, {
        init: function(d) {
            ...
            var e = this;
            d.afterError = d.afterError ||
            function(b) {
                alert(b)
            };
            e.options = d;
            e.progressbars = {};
            e.div = b(d.container).html(['<div class="ke-swfupload"><div class="ke-swfupload-top"><div class="ke-inline-block ke-swfupload-button"><input type="button" value="Browse" /></div>', '<div class="ke-inline-block ke-swfupload-desc">' + d.uploadDesc + "</div>", '<span class="ke-button-common ke-button-outer ke-swfupload-startupload">', '<input type="button" class="ke-button-common ke-button" value="' + d.startButtonValue + '" />', '</span></div><div class="ke-swfupload-body"></div></div>'].join(""));
            ...
            var h = {
                ...
                upload_error_handler: function(d) {
                    d && d.filestatus == SWFUpload.FILE_STATUS.ERROR && (d = b('div[data-id="' + d.id + '"]', e.bodyDiv).eq(0), j(d, e.options.errorMessage))
                },
            ...
            b(".ke-swfupload-startupload input", e.div).click(function() {
                e.swfu.startUpload()
            })
        },
        getUrlList: function() {
        ...
        appendFile: function(d) {
            var j = this,
            e = b('<div class="ke-inline-block ke-item" data-id="' + d.id + '"></div>');
            j.bodyDiv.append(e);
...
function(b) {
    ...
    var f = b.undef(d.uploadJson,upload_php),
    j = d.pluginsPath + "multiimage/images/",
    e = b.undef(d.imageSizeLimit, "1MB");
    b.undef(d.imageFileTypes, "*.jpg;*.gif;*.png");
    var h = b.undef(d.imageUploadLimit, 5),
    m = b.undef(d.filePostName, "imgFile"),
    n = d.lang("multiimage.");
    d.plugin.multiImageDialog = function(o) {
        var l = o.clickFn,
        o = b.tmpl(n.uploadDesc, {
            uploadLimit: h,
            sizeLimit: e
        }),
        s = d.createDialog({
            ...
            beforeRemove: function() { (!b.IE || b.V <= 8) && v.remove()
            }
        }),
        v = b.swfupload({
        ...
        d.plugin.multiImageDialog({
            clickFn: function(e) {
                ...
                function(b, e) {
                    ...
                    var theone_url = e.url;
                    theone_url = theone_url.replace("/Public/Editor/../..", "");
                    d.exec("insertimage", theone_url, e.title, e.width, e.height, e.border, e.align)
                }), setTimeout(function() {
                    d.hideDialog().focus()
                },
                0))
    ...
    SWFUpload.prototype.addSetting = function(b, d, f) {
        return d == void 0 ? this.settings[b] = f: this.settings[b] = d
    };
    ...
    SWFUpload.prototype.callFlash = function(b, d) {
        ...
        e;
        try {
            e = f.CallFunction('<invoke name="' + b + '" returntype="javascript">' + __flash__argumentsToXML(d, 0) + "</invoke>"),
            j = eval(e)
        } catch(h) {
    ...
    SWFUpload.prototype.setButtonDimensions = function(b, d) {
        ...
        if (f != void 0) f.style.width = b + "px",
        f.style.height = d + "px";
    ...
    SWFUpload.prototype.cleanUp = function(b) {
        ...
        window.__flash__removeCallback = function(b, d) {
            try {
                b && (b[d] = null)
            } catch(f) {}
        }
    ...
    SWFUpload.prototype.uploadProgress = function(b, d, f) {
        b = this.unescapeFilePostParams(b);
    ...
    SWFUpload.prototype.cancelQueue = function() {
        ...
        this.stopUpload();
        for (var b = this.getStats(); b.files_queued > 0;) this.cancelUpload(),
        b = this.getStats()
    },
    ...
    SWFUpload.queue.uploadCompleteHandler = function(b) {
        ...
        if (typeof d === "function" ? d.call(this, b) !== !1 : b.filestatus !== SWFUpload.FILE_STATUS.QUEUED) this.getStats().files_queued > 0 && this.queueSettings.queue_cancelled_flag === !1 ? this.startUpload() : (this.queueSettings.queue_cancelled_flag === !1 ? this.queueEvent("queue_complete_handler", [this.queueSettings.queue_upload_count]) : this.queueSettings.queue_cancelled_flag = !1, this.queueSettings.queue_upload_count = 0)
    }
})();
KindEditor.plugin("pagebreak",
function(b) {
    var d = this,
    f = b.undef(d.pagebreakHtml, '<hr style="page-break-after: always;" class="ke-pagebreak" />');
    d.clickToolbar("pagebreak",
    function() {
        var j = d.cmd,
        e = j.range;
        d.focus();
...
KindEditor.plugin("plainpaste",
function(b) {
    var d = this;
    d.clickToolbar("plainpaste",
    function() {
        var f = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + d.lang("plainpaste.").comment + '</div><textarea class="ke-textarea" style="width:408px;height:260px;"></textarea></div>',
        f = d.createDialog({
            name: "plainpaste",
            width: 450,
            ...
            yesBtn: {
                ...
                click: function() {
                    ...
                    e = b.escape(e),
                    e = e.replace(/ {2}/g, " &nbsp;"),
                    e = d.newlineTag == "p" ? e.replace(/^/, "<p>").replace(/$/, "</p>").replace(/\n/g, "</p><p>") : e.replace(/\n/g, "<br />$&");
...
KindEditor.plugin("preview",
function(b) {
    var d = this;
    d.clickToolbar("preview",
    function() {
        d.lang("preview.");
...
function(b) {
    ...
    var f = this,
    j = b.toMap("blockquote,center,div,h1,h2,h3,h4,h5,h6,p");
    f.clickToolbar("quickformat",
    function() {
        f.focus();
        for (var e = f.edit.doc,
        h = f.cmd.range,
        m = b(e.body).first(), n, o = [], l = [], s = h.createBookmark(!0); m;) {
            n = m.next();
            var v = d(m);
            if (!v || v.name != "img") if (j[m.name] ? (m.html(m.html().replace(/^(\s|&nbsp;|\u3000)+/ig, "")), m.css("text-indent", "2em")) : l.push(m), !n || j[n.name] || j[m.name] && !j[n.name]) l.length > 0 && o.push(l),
            l = [];
            m = n
        }
        b.each(o,
    ...
    e.plugin.table = {
        prop: function(n) {
            ...
            o = e.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function() {
                        ...
                        U = b(C[0]).html() || "",
                        W = b(C[1]).html() || "";
                        if (d == 0 || !/^\d+$/.test(d)) alert(e.lang("invalidRows")),
                        j[0].focus();
                        else if (f == 0 || !/^\d+$/.test(f)) alert(e.lang("invalidRows")),
                        m[0].focus();
                        else if (/^\d*$/.test(h)) if (/^\d*$/.test(n)) if (/^\d*$/.test(O)) if (/^\d*$/.test(Q)) if (/^\d*$/.test(H)) {
                            if (u) h !== "" ? u.width(h + o) : u.css("width", ""),
                            u[0].width !== void 0 && u.removeAttr("width"),
                            n !== "" ? u.height(n + I) : u.css("height", ""),
                            u[0].height !== void 0 && u.removeAttr("height"),
                            u.css("background-color", W),
                            u[0].bgColor !== void 0 && u.removeAttr("bgColor"),
                            O !== "" ? u[0].cellPadding = O: u.removeAttr("cellPadding"),
                            Q !== "" ? u[0].cellSpacing = Q: u.removeAttr("cellSpacing"),
                            R !== "" ? u[0].align = R: u.removeAttr("align"),
                            H !== "" ? u.attr("border", H) : u.removeAttr("border"),
                            H === "" || H === "0" ? u.addClass("ke-zeroborder") : u.removeClass("ke-zeroborder"),
                            U !== "" ? u.attr("borderColor", U) : u.removeAttr("borderColor"),
                            e.hideDialog().focus(),
                            e.cmd.range.moveToBookmark(l),
                            e.cmd.select();
                            else {
                                var S = "";
                                h !== "" && (S += "width:" + h + o + ";");
                        ...
                        G[0].focus();
                        else alert(e.lang("invalidSpacing")),
                        A[0].focus();
                        else alert(e.lang("invalidPadding")),
                        q[0].focus();
                        else alert(e.lang("invalidHeight")),
                        r[0].focus();
                        else alert(e.lang("invalidWidth")),
                        p[0].focus()
                    }
                }
            }).div,
            j = b('[name="rows"]', o).val(3),
            m = b('[name="cols"]', o).val(2),
            p = b('[name="width"]', o).val(100),
            r = b('[name="height"]', o),
            z = b('[name="widthType"]', o),
            D = b('[name="heightType"]', o),
            q = b('[name="padding"]', o).val(2),
            A = b('[name="spacing"]', o).val(0),
            B = b('[name="align"]', o),
            G = b('[name="border"]', o).val(1),
            C = b(".ke-input-color", o);
            f(o, C.eq(0));
            f(o, C.eq(1));
            d(C.eq(0), "#000000");
            d(C.eq(1), "");
            ...
            if (!n && (u = e.plugin.getSelectedTable())) {
                ...
                j.attr("disabled", !0);
                m.attr("disabled", !0);
                var I, n = u[0].style.width || u[0].width,
                o = u[0].style.height || u[0].height;
        ...
        cellprop: function() {
            var n = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keWidth" style="width:90px;">' + h.size + "</label>", h.width + ' <input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> &nbsp; ', '<select name="widthType">', '<option value="%">' + h.percent + "</option>", '<option value="px">' + h.px + "</option>", "</select> &nbsp; ", h.height + ' <input type="text" class="ke-input-text ke-input-number" name="height" value="" maxlength="4" /> &nbsp; ', '<select name="heightType">', '<option value="%">' + h.percent + "</option>", '<option value="px">' + h.px + "</option>", '</select></div><div class="ke-dialog-row">', '<label for="keAlign" style="width:90px;">' + h.align + "</label>", h.textAlign + ' <select id="keAlign" name="textAlign">', '<option value="">' + h.alignDefault + "</option>", '<option value="left">' + h.alignLeft + "</option>", '<option value="center">' + h.alignCenter + "</option>", '<option value="right">' + h.alignRight + "</option>", "</select> ", h.verticalAlign + ' <select name="verticalAlign">', '<option value="">' + h.alignDefault + "</option>", '<option value="top">' + h.alignTop + "</option>", '<option value="middle">' + h.alignMiddle + "</option>", '<option value="bottom">' + h.alignBottom + "</option>", '<option value="baseline">' + h.alignBaseline + "</option>", '</select></div><div class="ke-dialog-row">', '<label for="keBorder" style="width:90px;">' + h.border + "</label>", h.borderWidth + ' <input type="text" id="keBorder" class="ke-input-text ke-input-number" name="border" value="" maxlength="4" /> &nbsp; ', h.borderColor + ' <span class="ke-inline-block ke-input-color"></span>', '</div><div class="ke-dialog-row">', '<label for="keBgColor" style="width:90px;">' + h.backgroundColor + "</label>", '<span class="ke-inline-block ke-input-color"></span></div></div>'].join(""),
            o = e.cmd.range.createBookmark(),
            n = e.createDialog({
                name: "table",
                width: 500,
            ...
            l = b('[name="width"]', n).val(100),
            j = b('[name="height"]', n),
            m = b('[name="widthType"]', n),
            p = b('[name="heightType"]', n),
            r = b('[name="padding"]', n).val(2),
            z = b('[name="spacing"]', n).val(0),
            D = b('[name="textAlign"]', n),
            q = b('[name="verticalAlign"]', n),
            A = b('[name="border"]', n).val(1),
            B = b(".ke-input-color", n);
            f(n, B.eq(0));
            f(n, B.eq(1));
            d(B.eq(0), "#000000");
            d(B.eq(1), "");
            l[0].focus();
            l[0].select();
            var G = e.plugin.getSelectedCell(),
            C = G[0].style.height || G[0].height || ""; (n = /^(\d+)((?:px|%)*)$/.exec(G[0].style.width || G[0].width || "")) ? (l.val(n[1]), m.val(n[2])) : l.val("");
            if (n = /^(\d+)((?:px|%)*)$/.exec(C)) j.val(n[1]),
            p.val(n[2]);
            D.val(G[0].style.textAlign || "");
            q.val(G[0].style.verticalAlign || ""); (n = G[0].style.borderWidth || "") && (n = parseInt(n));
            A.val(n);
        ...
        colinsert: function(d) {
            var f = e.plugin.getSelectedTable()[0],
            h = e.plugin.getSelectedRow()[0],
            m = e.plugin.getSelectedCell()[0],
            d = m.cellIndex + d;
            d += f.rows[0].cells.length - h.cells.length;
            for (var h = 0,
            v = f.rows.length; h < v; h++) {
                var p = f.rows[h],
                d = p.insertCell(d);
                d.innerHTML = b.IE ? "": "<br />";
                d = j(f, p, d)
        ...
        rowmerge: function() {
            ...
            h = d.rowIndex + f.rowSpan,
            d = b.rows[h];
            if (! (b.rows.length <= h)) b = f.cellIndex,
            d.cells.length <= b || (h = d.cells[b], f.colSpan === h.colSpan && (f.rowSpan += h.rowSpan, d.deleteCell(b), e.cmd.range.selectNodeContents(f).collapse(!0), e.cmd.select(), e.addBookmark()))
        },
        colmerge: function() {
            e.plugin.getSelectedTable();
            var b = e.plugin.getSelectedRow()[0],
            d = e.plugin.getSelectedCell()[0],
            f = d.cellIndex + 1;
            if (! (b.cells.length <= f)) {
                var h = b.cells[f];
                d.rowSpan === h.rowSpan && (d.colSpan += h.colSpan, b.deleteCell(f), e.cmd.range.selectNodeContents(d).collapse(!0), e.cmd.select(), e.addBookmark())
            }
        },
        rowsplit: function() {
            var d = e.plugin.getSelectedTable()[0],
            f = e.plugin.getSelectedRow()[0],
            h = e.plugin.getSelectedCell()[0],
            m = f.rowIndex;
            if (h.rowSpan !== 1) {
        ...
        rowdelete: function() {
            ...
            d.rows.length === 0 ? (e.cmd.range.setStartBefore(d).collapse(!0), e.cmd.select(), b(d).remove()) : e.cmd.selection(!0);
            e.addBookmark()
        }
    };
...
function(b) {
    ...
    f.clickToolbar("template",
    function() {
        var e = f.lang("template."),
        h = ['<div style="padding:10px 20px;">', '<div class="ke-header">', '<div class="ke-left">', e.selectTemplate + " <select>"];
        b.each(e.fileList,
        function(b, d) {
            h.push('<option value="' + b + '">' + d + "</option>")
        });
        html = [h.join(""), '</select></div><div class="ke-right">', '<input type="checkbox" id="keReplaceFlag" name="replaceFlag" value="1" /> <label for="keReplaceFlag">' + e.replaceContent + "</label>", '</div><div class="ke-clearfix"></div></div><iframe class="ke-textarea" frameborder="0" style="width:458px;height:260px;background-color:#FFF;"></iframe></div>'].join("");
...
KindEditor.plugin("wordpaste",
function(b) {
    var d = this;
    d.clickToolbar("wordpaste",
    function() {
        var f = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + d.lang("wordpaste.").comment + '</div><iframe class="ke-textarea" frameborder="0" style="width:408px;height:260px;"></iframe></div>',
        f = d.createDialog({
            name: "wordpaste",
            width: 450,
            ...
            yesBtn: {
                name: d.lang("yes"),
                click: function() {
                    var e = j.body.innerHTML,
                    e = b.clearMsWord(e, d.filterMode ? d.htmlTags: b.options.htmlTags);
                    d.insertHtml(e).hideDialog().focus()
                }
            }
        }).div,
