            ...
            <table class="table table-hover">
              ...
              <tbody id="list-tbody">
                  <?php if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty_msg" ;else: foreach($__LIST__ as $key=>$data): $mod = ($key % 2 );++$key;?><tr id="<?php echo ($data["id"]); ?>" visible="<?php echo ($data["zl_visible"]); ?>" opCheck='0'>
                      ...
                      <a href="/sys-index.php/Article/edit/tnid/<?php echo ($data["id"]); ?>" title="<?php echo L("LABEL_OS_EDITID");?>[<?php echo ($data["id"]); ?>]"><i class="fa fa-edit"></i></a>
             		  <a href="/sys-index.php/Article/relation/tnid/<?php echo ($data["id"]); ?>" title="<?php echo L("LABEL_SET_RELATION");?>[<?php echo ($data["id"]); ?>]"><i class="fa fa-puzzle-piece"></i></a>
