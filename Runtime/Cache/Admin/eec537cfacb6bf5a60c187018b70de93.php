...
<div class="col-xs-12 col-sm-9 col-lg-10"> 
  ...
  <div class="clearfix welcome-container">
        ...
        <div class="panel panel-info">
          <div class="panel-body" style="position:relative;">
			...
			<div class="form-group">
                          <label class="col-xs-12 col-sm-3 col-md-2 col-lg-1 control-label">注册日期</label>
            ...
            <div class="form-group">
              <label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">角色/邦定</label>
              <div class="col-sm-8 col-lg-10 col-xs-12">
                <div class="col-lg-3"><select class="form-control" id="bind"><?php echo ($bind_str); ?></select></div>
	...
	<div class="panel-body">
            ...
            <span><i class="fa fa-list-ol"></i> 老师列表</span>
            ...
            <table class="table table-hover">
              <thead class="navbar-inner">
                  <tr>
                    ...
                    <th style="width:270px;">ID/帐户名/昵称</th>
                    <th style="width:80px;">直播数</th>
                    <th style="width:80px;">录播数</th>
                    <th>学校</th>
              ...
              <tbody id="list-tbody">
                  <?php if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty_msg" ;else: foreach($__LIST__ as $key=>$data): $mod = ($key % 2 );++$key;?><tr id="<?php echo ($data["id"]); ?>" visible="<?php echo ($data["zl_visible"]); ?>" opCheck='1' msg='1'>
                      ...
                      <td><a href="javascript:viewLesson(<?php echo ($data["id"]); ?>,1)"> <?php echo ($data["live_total"]); ?></a></td>
                      <td><a href="javascript:viewLesson(<?php echo ($data["id"]); ?>,2)"> <?php echo ($data["vod_total"]); ?></a></td>
                      <td><?php echo ($data["zc_school"]); ?></td>
                      <td>
                        <div class="btn-group"> 
                      ...
                      <td class="manage-menu list-os-a">
                          ...
                          <?php if($data["zl_role"] == '2'): ?><a href="/sys-index.php/Member/auth/tnid/<?php echo ($data["id"]); ?>" title="查看认证信息">认证审核</a><?php endif; ?>
...
function viewLesson(id,type)
{
    var urlpara =base64encode("teacher_id/"+id+"/");
    if(type == 1) url = "/sys-index.php/Live/";
    else url = "/sys-index.php/Vod/";
    window.location.href = url+"index/s/"+urlpara;
}
