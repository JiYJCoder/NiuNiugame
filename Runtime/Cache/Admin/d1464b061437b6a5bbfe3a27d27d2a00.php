...
<div class="login">
  ...
  <div class="center-block footer" role="footer">
    <div class="text-center"> Powered by <a href="#"><b><?php echo L('PROJECT_TEAM');?></b></a> <?php echo L('PROJECT_COPYRIGHT');?>  </div>
  </div>
</div>
<script>
...
$(document).ready(function() {
    ...
    $("#get_code_img").click(function () {
        document.getElementById('code_img').src = "<?php echo U('Login/checkCode');?>/v/" + Math.random();
        void(0);
    });
    //回车
