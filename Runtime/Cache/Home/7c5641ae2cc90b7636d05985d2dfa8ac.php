...
<script>
    ...
    <div class="detail-wrapper video-detail-wrapper">
        <div class="zr_layout" style="margin-bottom: 44px;">
             ...
             <!--    <div class="live-detail-bread">
                ...
                <div class="play-info">
                    <a class="video-info"  >
                        ...
                        <div class="mask"></div>
                        <?php if($detailInfo['is_enroll'] == 1): ?><div class="playe-video-icon" vodLessonId="<?php echo ($detailInfo['new_lesson_id']); ?>"
                             teacherId="<?php echo ($teacherInfo["id"]); ?>" liveId="<?php echo ($detailInfo["id"]); ?>"></div>
                            <?php else: ?>
                        <div class="playe-video-icon"></div><?php endif; ?>
                        <div class="describe">
                    ...
                    <div class="video-list">
                        <ul>
                            <?php if($detailInfo['is_enroll'] == 1): if(is_array($detailInfo['lessonInfo'])): foreach($detailInfo['lessonInfo'] as $key=>$value): if($value['is_new'] == 1): ?><li class="active" >
                                        <a href="" vod_id="<?php echo ($value['lesson_id']); ?>" watch_length="<?php echo ($value['zc_vod_time']); ?>">
                                            <i class="line"></i>
                                            <div class="sort"><?php echo ($key +1); ?></div>
                                            <div class="title" ><?php echo ($value['lesson_title']); ?></div>
                                        </a>
                                    </li>
                                    <?php elseif($value['is_study'] == 1): ?>
                                    <li >
                                    <a href="" style="color:#999"  vod_id="<?php echo ($value['lesson_id']); ?>" watch_length="<?php echo ($value['zc_vod_time']); ?>">
                                        <i class="line"></i>
                                        <div class="sort"><?php echo ($key +1); ?></div>
                                        <div class="title" ><?php echo ($value['lesson_title']); ?></div>
                                    </a>
                ...
                <div class="teacher-info">
                    <div class="info-left">
                        <img class="header" src="<?php echo ($teacherInfo['zc_headimg']); ?>" alt="">
                        ...
                        <?php if(($teacherInfo["is_auth"]) == "1"): ?><span class="accreditation-teacher">认证教师</span><?php endif; ?>
                        <div class="statistics">
                            <span>学生数:<?php echo ($teacherInfo["student_num"]); ?></span>
                            <span>直播课程:<?php echo ($teacherInfo["live_num"]); ?></span>
                            <span>录播课程:<?php echo ($teacherInfo["vod_num"]); ?></span>
                        </div>
                    </div>
                    <div class="info-mind">
                        <p>
                           <?php echo ($detailInfo['zc_summary']); ?>
                        </p>
                    </div>
                    ...
                    <ul class="clearfix">
                        ...
                        <li class="tabs tabs-course-table">
                            ...
                            <?php if(is_array($detailInfo["lessonInfo"])): $i = 0; $__LIST__ = $detailInfo["lessonInfo"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lesson): $mod = ($i % 2 );++$i;?><div class="row <?php if(($lesson["is_study"]) != "1"): ?>no-join-course<?php endif; ?>">
                                <?php if(($detailInfo["is_enroll"]) == "1"): ?><div class="join">
                                    <i class="join-icon"></i>
                                    <?php if(($lesson["is_study"]) != "1"): ?><span>未观看</span><?php else: ?>
                                        <span>已观看</span><?php endif; ?>
