        ...
        <div class="zr_layout live-course-contain">
            <div class="tabhead">
                <ul class="clearfix">
                    ...
                    <li class="active last-link">
                        <a href="<?php echo U('/Student/vodexpire');?>">已过期</a>
                    </li>
                </ul>
            </div>
            <div class="course-list-contain">
                <?php if($vod_msg): if(is_array($vod_msg)): foreach($vod_msg as $key=>$value): if($value['zl_status'] == 1): ?><div class="s-zx-course-list">
                        ...
                        <div class="keep-studying">
                            <a class="hover-btn" href="<?php echo U('/Vod/videodetail',array('tnid' => $value['vod_id']));?>">查看回放</a>
                        </div>
                    </div>
