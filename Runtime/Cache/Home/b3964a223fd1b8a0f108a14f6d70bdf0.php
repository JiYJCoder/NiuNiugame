        ...
        <div class="course-list-contain">
            <?php if($vod_msg): if(is_array($vod_msg)): foreach($vod_msg as $key=>$value): if($value['total'] < $value['total_lesson_num']): ?><div class="s-zx-course-list">
                        ...
                        <div class="keep-studying">
                            <a  href="javascript:void(0);" class="hover-btn cancel_favorite  cancel_favorite_vod" cid="<?php echo ($value['vod_id']); ?>" href="">取消收藏</a>
                        </div>
                    </div>
                    ...
                    <div class="s-zx-course-list">
                        ...
                        <div class="keep-studying">
                            <a class="hover-btn" href="">继续学习</a>
                        </div>
                    </div>
                    <!-- 当课程不能访问添加no-visit -->
                    <?php elseif($value['zl_status'] == 2): ?>
                    <div class="s-zx-course-list no-visit">
                        <img class="picture" src="/Tpl-website/pc/res/images/teacher/10.jpg" alt="">
                        <div class="course-detail">
                            <div class="row clearfix">
                                <h3 class="item-title">早教专家教你如何与孩子良好地相处</h3>
                            </div>
                            <div class="row clearfix sub-title">
                                <span>小学数学</span>
                                <span>海绵宝宝</span>
                        ...
                        <div class="lb_info fl clearfix">
                            <div class="fl">
                                ...
                                <div class="curriculum_name_list">
                                    <a class="hover-btn" href="<?php echo U('/Vod/index');?>">去收藏</a>
                                </div>
                            </div>
                        </div>
                </div><?php endif; ?>
