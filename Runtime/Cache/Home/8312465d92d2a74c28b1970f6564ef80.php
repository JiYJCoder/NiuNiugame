...
navAnimate();
    ...
    <div class="chart_wrapper ">
        <div class="chart_bg">
            <div class="zr_layout chrat_out">
                <div class="select">
                    <h3>课程数据</h3>
                    <div class="select_input">
                        <select class="select_zb_course select_zb_course_1">
                            <option value="1">直播课程</option>
                            <option value="2">录播课程</option>
                        </select>
                        <!--直播-->
                        <select class="select_zb_course two-stage two-stage1">
                            <?php if(is_array($message)): foreach($message as $key=>$value): ?><option value="<?php echo ($value['id']); ?>"><?php echo ($value['zc_title']); ?></option><?php endforeach; endif; ?>
                        </select>
                        <!--录播-->
                        <select class="select_zb_course two-stage two-stage2" style="display: none;">
                            <?php if(is_array($vod_message)): foreach($vod_message as $key=>$value): ?><option value="<?php echo ($value['id']); ?>"><?php echo ($value['zc_title']); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                </div>
                <div id="chart"></div>
    ...
    <div class="main-wrapper">
        <div class="main_layout">
            <div class="in_zb_course_live">
                <div class="zb_coure_title">
                    <i></i>
                    <h1>进行中的直播课程</h1>
                    <!-- <span class="zb_status_text">直播申请</span> -->
                </div>
                <div class="zb_content clearfix">
                    <!-- 没有课程 -->
                    <?php if(($has_Mylive) == "0"): ?><div class="no_zb">
                            <div>
                                <img class="no_zb_pic" src="/Tpl-website/pc/res/images/teacher/teacher_image_noClass.jpg" alt="">
                            </div>
                            <div class="xg_datum">
                                <span><a href="<?php echo U('sqlive');?>"> 申请直播</a></span>
                            </div>
                        </div>
                        <?php else: ?>
                        <?php if(is_array($message)): $i = 0; $__LIST__ = array_slice($message,0,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><!-- 老师有直播应该展示的状态 -->
                            <!-- 有直播的时候 -->
                            <?php if($value['zl_status'] == 6): ?><div class="zb_list">
                                    <div class="zb_list_info">
                                        <img class="list_inof_bg" src="/Tpl-website/pc/res/images/zb_info_title_bg.png" alt="">
                                        <div class='info_title_wrapper'>
                                            <h2 class="sub_title"><?php echo ($value['cat_id_label']); ?></h2>
                                            <h1 class='inof_title'><?php echo ($value['zc_title']); ?></h1>
                                            <div class="z_inof_bottom">
                                                <div>
                                                    <span>剩余课节:</span>
                                                    <span class="z_t_classes"><?php echo ($value['all_class']-$value['finish_class']); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="zb_panel">
                                        <div class="tl_address">
                                            <i class="icon"></i>
                                            <span class="tl_triangle"></span>
                                            <span class="tl_text_13">推流地址</span>
                                            <!--  <div class="copy_address">
                                            <p class="address_text"><?php echo ($value['zc_push_url_first']); ?></p>
                                            <p class="address_text"><?php echo ($value['zc_push_url_second']); ?></p>
                                            <input class="copyBtn" data-clipboard-text="<?php echo ($value['zc_push_url_second']); ?>"
                                                   aria-label="复制成功！" type="button" value='复制地址'>
                                        </div> -->
                                        ...
                                        <div class="next_zb_titme">
                                            <?php if($value['living'] == 1): ?><span>正在上课</span>
                                                ...
                                                <span>未安排下次课程</span>
                                                <?php else: ?>
                                                <span class="next_zb_text1" next_time="<?php echo ($value['next_class_time']); ?>">距离下次直播还有</span>
                                                ...
                                                <span>分</span><?php endif; ?>
                                        </div>
                                        <div class="zb_number clearfix">
                                            <div class="item">
                                                <span class="number_text"><?php echo ($value['favorite']); ?>人</span>
                                                <span class="number_text2">收藏数</span>
                                            </div>
                                            <div class="item">
                                                <div class="line line1"></div>
                                                <span class="number_text"><?php echo ($value['enroll']); ?>人</span>
                                                <span class="number_text2">报名数</span>
                                                <div class="line line2"></div>
                                            </div>
                                            <div class="item">
                                                <span class="number_text" style="font-size:28px;">NO.<?php echo ($value['rank']); ?></span>
                                                <span class="number_text2" style="clear:both;">课程排名</span>
                                            </div>
                                        </div>
                                        <div class="xg_datum clearfix">
                                            <div class="datum_buttom1">
                                                <a class="hover_btn" href="<?php echo U('teacher/completecourse',array(id => $value['id']));?>">完善课程资料</a>
                                            </div>
                                            <div>
                                                <a class="hover_btn" href="<?php echo U('teacher/courselist',array(id => $value['id']));?>">查看名单</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <?php elseif($value['zl_status'] == 3): ?>
                                <div class="zb_list">
                                    <div class="zb_list_info">
                                        <img class="list_inof_bg" src="<?php echo ($value['image']); ?>" alt="">
                                        <div class='info_title_wrapper'>
                                            <h2 class="sub_title"><?php echo ($value['cat_id_label']); ?></h2>
                                            <h1 class='inof_title'><?php echo ($value['zc_title']); ?></h1>
                                            <!-- 没有直播不显示 -->
                                    ...
                                    <!-- 老师没有直播应该展示的状态 -->
                                    <div class="no_zb_panel">
                                        <i class="status_icon icon2"></i>
                                        <div class="zb_sk_status">
                                            <!-- 审核没有通过出现sjx_show(三角形) -->
                                            <span class="status_text sjx_show">审核未通过,查看原因</span>
                                            <!--  只有审核没有通过才会出现原因-->
                                            <span class="no_pass_reason"><?php echo ($value['zc_reason']); ?></span>
                                        </div>
                                ...
                                <div class="zb_list">
                                    ...
                                    <!-- 老师没有直播应该展示的状态 -->
                                    <div class="no_zb_panel">
                                        <i class="status_icon icon1"></i>
                                        <div class="zb_sk_status">
                                            <span class="status_text">审核已通过</span>
                                        </div>
                                        <!-- 审核通过显示pass 没有 通过显示no_pass -->
                                        <div class="curriculum_name_list pass">
                                            <?php echo ($value['btn']); ?>
                                        </div>
                                    </div>
            ...
            <div class="lb_content">
                ...
                <?php if($has_vod == 1): ?><!-- 录播遍历开始 -->
                    <?php if(is_array($vod_message)): foreach($vod_message as $key=>$value2): if($value2['zl_status'] == 6): ?><div class="lb_list">
                                <div class="lb_list_item clearfix">
                                    ...
                                    <div class="lb_info fl clearfix">
                                        <div class="fl">
                                            <div>
                                                <h3 class="lb_list_title"><?php echo ($value2['zc_title']); ?></h3>
                                                <div>
                                                    <div class="number_of_courses">
                                                        <div class="p_r_23" style="padding-right: 23px;">
                                                            <span><?php echo ($value2['cat_id_label']); ?></span>
                                                        </div>
                                                        <div>
                                                            <span>共上</span>
                                                            <span class="orange_color"><?php echo ($value2['all_class']); ?></span>
                                                            <span>节，</span>
                                                        </div>
                                                        <div>
                                                            <span>已上</span>
                                                            <span class="orange_color"><?php echo ($value2['finish_class']); ?></span>
                                                            <span>节</span>
                                                        </div>
                                                    </div>
                                                    <div class="stra_number">
                                                        <div>
                                                            <span class="sc_number"><?php echo ($value2['favorite']); ?></span>
                                                            <span class="sc_number_text">人收藏</span>
                                                        </div>
                                                        <div>
                                                            <span class="bm_number"><?php echo ($value2['favorite']); ?></span>
                                                            <span class="bm_number_text">人报名</span>
                                                        </div>
                                                        <div>
                                                            <span class="kc_number_text">课程排名第</span>
                                                            <span><?php echo ($value2['rank']); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="lb_list_item clearfix">
                                    ...
                                    <div class="lb_info fl clearfix">
                                        ...
                                        <div class="fr lb_sq_status">
                                            ...
                                            <div class="zb_sk_status">
                                                <!-- 审核没有通过显示sjx_show类名 -->
                                                <span class="status_text sjx_show">课程已下架，查看原因</span>
                                                <!-- 审核没有通过的原因 -->
                                                <span class="no_pass_reason"><?php echo ($value2['zc_reason']); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <?php elseif($value2['zl_status'] == 4): ?>
                            <div class="lb_list">
                                <div class="lb_list_item clearfix">
                                    <div class="lb_head_sculpture fl">
                                        <img src="<?php echo ($value2['image']); ?>" alt="">
                                    ...
                                    <div class="lb_info fl clearfix">
                                        ...
                                        <div class="fr lb_sq_status">
                                            <i class="status_icon icon3"></i>
                                            <div class="zb_sk_status">
                                                <!-- 审核没有通过显示sjx_show类名 -->
                                                <span class="status_text">等待审核中</span>
                                                <!-- 审核没有通过的原因 -->
                                                <!-- <span class="no_pass_reason"></span> -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="lb_list_item no_lb clearfix">
                            ...
                            <div class="lb_info fl clearfix">
                                <div class="fl">
                                    ...
                                    <div class="curriculum_name_list">
                                        <a class="hover_btn" href="<?php echo U('teacher/sqbroadcast');?>">申请录播课程</a>
                                    </div>
                                </div>
                                <!-- <div class="fr lb_sq_status">
                        <i class="status_icon icon1"></i>
...
<script>
require(['teacherIndex', 'teacher'], function(teacherIndex, teacher) {
    teacherIndex.loadTip();
    teacher();
});
</script>