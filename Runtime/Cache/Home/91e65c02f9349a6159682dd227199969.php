...
<script>
    ...
    <div class="search-index-pege">
        <?php if($count > 0): ?><div class="zr_layout">
            <div class="s-search-info-bar">
                <div class="search-text-record">
                    搜索<i>“<?php echo ($kw); ?>”</i>共找到 <i><?php echo ($count); ?>条</i> 有关记录
                </div>
            </div>
            <div class="s-search-content">
                <!-- 搜索老师页面 -->
                <div class="search-live-content search-teacher">
                    <div class="live-text">老师</div>
                    <div class="live-list">
                        <ul class="clearfix">
                            <?php if(is_array($teacher_search_info)): foreach($teacher_search_info as $key=>$value): ?><li >
                                <a href="<?php echo U('/Search/teacherdetail',array('tnid' => $value['id']));?>">
                                    <p class="student-count"><?php echo ($value['student_num']); ?>个学生</p>
                                    <div class="picturebox">
                                        <i class="live-icon"></i>
                                        <i class="paly-icon"></i>
                                        <img src="<?php echo ($value['zc_headimg']); ?>" alt="">
                                        <div class="time">
                                            <span class="date"><?php echo ($value['zc_nickname']); ?>老师</span>
                                            <span class="clock"><?php echo ($value['zc_school']); ?></span>
                                        </div>
                                    </div>
                                    <div class="course-info">
                                        <div class="row">
                                            <span><?php echo ($value['live_course']); ?></span>
                                            <p>直播课程</p>
                                        </div>
                                        <div class="row">
                                            <span><?php echo ($value['vod_course']); ?></span>
                                            <p>录播课程</p>
                                        </div>
                                        <div class="row">
                                            <span><?php echo ($value['favorite_num']); ?></span>
                                            <p>收藏</p>
                                        </div>
                                    </div>
                                </a>
                    ...
                    <div class="list_page" style="right:185px;bottom:-360px">
                        <?php echo ($page); ?>
                    </div>
                </div>
            </div>
        ...
        <!-- 没有搜索到东西页面 -->
        <?php else: ?>
        <div class="no-found-search" >
            <div class="no-found-content">
                <img src="/Tpl-website/pc/res/images/teacher/no-findthing-8237.png" alt="">
                <div class="text">抱歉，未搜到有关<i>“<?php echo ($kw); ?>”</i>的记录</div>
            </div>
        </div><?php endif; ?>
    </div>
