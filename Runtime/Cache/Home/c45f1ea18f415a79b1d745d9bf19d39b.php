...
navAnimate();
    ...
    <style>
    .sq_com_course .sq_com_content .item .sliderLeft span {
        margin-left: 0;
    }
    </style>
    <!-- <div class="banner_bg"></div> -->
    <div class="t_info_wrapper s_q_live_wrapper complete_course sq_com_course" fid_id="<?php echo ($message['id']); ?>">
        <!-- 上传box -->
        <div class="sr-upload-file-box" style="display: none;">
            <form class="upload-wrp">
                <div class="title">
                    <span>文件名称:</span>
                    <input class="has_boxshaw place-edit-file-name" type="text" placeholder="请输入文件名称">
                </div>
                <div class="upload-bottom">
                    <div class="upload-btn">
                        <input class="upload-video-btn" id="files" type="file" accept=".ppt,.pptx" value="上传文件">
                        <button type="button" name="button">上传文件</button>
                    </div>
                    <input class="start-upload" type="button" value="开始上传">
                </div>
                <i class="close-file"></i>
            </form>
        </div>
        <div class="zr_layout">
            
            <div class="content sq_com_content">
            <div class="t_s_content s_q_live" style="padding-left: 0;">
                <h1 class="s_q_title">完善课程资料</h1>
            </div>
                <div class="item clearfix">
                    <h3 class="c_title fl">课程分类</h3>
                    <div class="fl sliderLeft clearfix">
                        <span class="addGray"><?php echo ($message['zc_caption']); ?></span>
                        <span class="addGray">></span>
                        <span class="addGray"><?php echo ($message['cat_id_label']); ?></span>
                    </div>
                </div>
                <div class="item clearfix">
                    <h3 class="c_title fl">课程名称</h3>
                    <div class="fl sliderLeft clearfix">
                        <span class="addGray"><?php echo ($message['zc_title']); ?></span>
                    </div>
                </div>
                <div class="item clearfix">
                    <h3 class="c_title fl">课程封面</h3>
                    <div class="fl sliderLeft clearfix">
                        <img class="course_pic" src="<?php echo ($message['image']); ?>" alt="">
                    </div>
                </div>
                <div class="item clearfix">
                    <h3 class="c_title fl">课程简介</h3>
                    <div class="fl sliderLeft clearfix course_brief">
                        <span class="addGray"><?php echo ($message['zc_summary']); ?></span>
                    </div>
                </div>
                <div class="item clearfix">
                    <div class="course_syllabus clearfix">
                        <div class="clearfix">
                            <h1 class="c_title sub_title fl">课程表</h1>
                            <div class="fl" style="position: relative;top: -10px;left:13px">
                                ...
                                <div class="fl">
                                    <input style="display:none" class="add_btn add_double_btn" type="button" value="添加多节">
                        ...
                        <div class="sq_syllabus">
                            ...
                            <!--<span class="sq_syllabus_title fl">对方答复</span>-->
                            <!--<div class="syllabus_title fl">-->
                            <!--<span style="padding-right:4px;" class="sq_syllabus_date">2017-07-06</span>-->
                            <!--<span class="k_srStartTime1">01:01</span>-->
                            <!--<span>-</span>-->
                            <!--<span class="k_srStartTime2">00:02</span>-->
                            <!--</div>-->
                            <!--</div>-->
                            <!--<div class="syllabus_right fr">-->
                            <!--<i class="revise"></i>-->
                            <!--<i class="upload_coures_file"></i>-->
                            <!--<input type="file">-->
                            <!--</div>-->
                            <!--</div>-->
                            <?php if(is_array($message2)): $i = 0; $__LIST__ = $message2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><div class="syllabus_list clearfix" val="<?php echo ($value['id']); ?>">
                                    <div class="list_left fl">
                                        <span class="sq_syllabus_no fl"><?php echo ($i); ?>.</span>
                                        <span class="sq_syllabus_title fl"><?php echo ($value['zc_title']); ?></span>
                                        <div class="syllabus_title fl">
                                            <span style="padding-right:4px;" class="sq_syllabus_date"><?php echo ($value['zc_date']); ?></span>
                                            <span class="k_srStartTime1"><?php echo ($value['zc_start_time']); ?></span>
                                            <span>-</span>
                                            <span class="k_srStartTime2"><?php echo ($value['zc_end_time']); ?></span>
                                        </div>
                                    </div>
                                    <div class="upload-ppt-file syllabus_right fr">
                                        <i title="编辑课程" class="revise"></i>
                                        <?php if($value['zc_file'] > 0): ?><i class="has_coures_file"></i>
                                            <?php else: ?>
                                            <i class="upload_coures_file"></i><?php endif; ?>
                                        <input title="请选择ppt" val="<?php echo ($value['id']); ?>" accept=".ppt,.pptx" type="file">
                                    </div>
                ...
                <div class="item clearfix">
                    <h3 class="c_title fl" style="padding-right:21px">课程描述</h3>
                    <div class="fl sliderLeft clearfix">
                        <textarea ID="editor_id" name="content" style="width:700px;height:258px;"><?php echo ($message['zc_content']); ?></textarea>
                    </div>
                </div>
                <div class="item clearfix">
                    <h3 class="c_title fl">资料上传</h3>
                    <div class="fl sliderLeft clearfix">
                        <div class=uploadBtn>
                            上传
                        </div>
                        <div class="fileBox clearfix">
                            <?php if(is_array($message3)): foreach($message3 as $key=>$value): ?><div class="file_list">
                                    <span class="upload_file_bg"></span>
                                    <i class="file_icon"></i>
                                    <span class="file_file_text">FILE</span>
                                    <i class="del_file" oss_id="<?php echo ($value['id']); ?>"></i>
                                    <span class="file_text"><?php echo ($value['zc_file_name']); ?></span>
                                </div><?php endforeach; endif; ?>
                        </div>
                    </div>
                </div>
                <input type="button" class="save_datum complete_save_btn" value="保存修改">
            </div>
        </div>
    </div>
...
<script src="/Tpl-website/pc/res/plugins/kindeditor/kindeditor.js"></script>
<script src="/Tpl-website/pc/res/plugins/kindeditor/lang/zh_CN.js"></script>
<script>
var editor;
...
require(["syllabus", "datePicker", "timePicker", "layer", "complete"], function(syllabus, datePicker, timePicker, layer, complete) {
    //初始化日历和时间
