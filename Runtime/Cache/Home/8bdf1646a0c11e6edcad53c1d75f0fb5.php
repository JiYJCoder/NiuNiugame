    ...
    <div class="s-m-course-banner">
        <div class="zr_layout">
            ...
            <div class="c-statistics">
                <div class="record-registration row" style="margin-left:300px;">
                    <span class="count"><?php echo ($student_msg['vod_num']); ?></span>
                    <span class="text2">录播报名</span>
                </div>
                <div class="record-registration row" style="margin-left:68px;">
                    <span class="count"><?php echo ($student_msg['live_num']); ?></span>
                    <span class="text2">直播报名</span>
                </div>
                <div class="record-registration row" style="margin-left:77px;">
                    <span class="count"><?php echo ($student_msg['time']); ?></span>
                    <span class="text1"><?php echo ($student_msg['time_unit']); ?></span>
                    <span class="text2">总观看时长</span>
                </div>
                <div class="record-registration row" style="margin-left:57px;">
                    <span class="count"><?php echo ($student_msg['teacher_num']); ?></span>
                    <span class="text1">位</span>
                    <span class="text2">听过老师数量</span>
                </div>
                <div class="record-registration row" style="margin-left:83px;">
                    <span class="count">0</span>
                    <span class="text1">元</span>
                    <span class="text2">总花费</span>
                </div>
            </div>
        </div>
        ...
        <i class="circle circle5"></i>
        <i class="circle circle6"></i>
        <i class="circle circle7"></i>
        <i class="circle circle8"></i>
        <i class="circle circle9"></i>
        <i class="circle circle10"></i>
        <i class="circle circle11"></i>
        <i class="circle circle12"></i>
        <i class="circle circle13"></i>
        <i class="circle circle14"></i>
    </div>
    <div class="recently-study-course">
        <div class="my-course-content zr_layout">
            <div class="title">
                <h1>最近学习的课程</h1>
                <div style="display: inline-block;">
                    <span class="active tab">直播课程</span>
                    <span class="tab">录播课程</span>
                </div>
            </div>
            <div class="course-list-wapper tabcontain course-tab-1">
                <?php if($live_msg): if(is_array($live_msg)): foreach($live_msg as $key=>$value): if(($value['id'] > 0) AND ($value['zl_status'] == 6)): ?><div class="s-zx-course-list">
                            <img class="picture" src="<?php echo ($value['zc_image']); ?>" alt="">
                            <div class="course-detail">
                                <div class="row clearfix">
                                    <h3 class="item-title"><?php echo ($value['live_title']); ?></h3>
                                </div>
                                ...
                                <div class="row progress-text">
                                    <span class="recently-live-time">最近直播:<?php echo ($value['zc_date']); ?> <?php echo ($value['zc_start_time']); ?>-<?php echo ($value['zc_end_time']); ?></span>
                                </div>
                            </div>
                            <div class="keep-studying">
                                <a class="hover-btn" href="<?php echo U('/Live/livedetail',array('tnid' => $value['live_id']));?>">继续学习</a>
                            </div>
                        </div>
                        <?php else: ?>
                        ...
                        <div class="lb_info fl clearfix">
                            <div class="fl">
                                ...
                                <div class="curriculum_name_list">
                                    <a class="hover-btn" href="<?php echo U('/Live/index');?>">去报名</a>
                                </div>
                            </div>
                        </div>
                </div><?php endif; ?>
            </div>
            <div class="course-list-wapper tabcontain course-tab-2">
                <?php if($vod_msg): if(is_array($vod_msg)): foreach($vod_msg as $key=>$value): if($value['zn_total'] < $value['total_lesson_num']): ?><div class="s-zx-course-list">
                            <img class="picture" src="<?php echo ($value['zc_image']); ?>" alt="">
                            <div class="course-detail">
                                <div class="row clearfix">
                                    <h3 class="item-title"><?php echo ($value['zc_title']); ?></h3>
                                    <i class="icon">更新</i>
                                </div>
                                <div class="row clearfix sub-title">
                                    <span><?php echo ($value['zn_cat_name']); ?></span>
                            ...
                            <div class="keep-studying">
                                <a class="hover-btn" href="<?php echo U('/Vod/videodetail',array('tnid' => $value['id']));?>">查看回放</a>
                            </div>
                        </div>
                        <?php else: ?>
                        <div class="s-zx-course-list">
...
<script>
require(["myCourse"], function(myCourse) {
    myCourse()
})
</script>