...
define("REL_ROOT", "/");
define("API_DOMAIN", "http://dev.zier365.com");
...
//聊天缓存
define("COMMON_TALK", RUNTIME_PATH . "Temp/");
//前端模板目录
...
define("NO_AVATAR", REL_ROOT. "Public/Static/images/noavatar.png"); // 老师默认头像
define("NO_AVATAR_STUDENT", REL_ROOT. "Public/Static/images/noavatar_student.png"); // 学生默认头像
define("NO_CLASS_PIC", REL_ROOT. "Public/Static/images/noclasspic.png");
