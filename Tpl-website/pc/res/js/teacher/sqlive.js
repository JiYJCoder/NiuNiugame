define(["datePicker", "timePicker", "layer", "syllabus", "myAjx"], function(datePicker, timePicker, layer, syllabus, myAjx) {
    var loadTip = function() {
        $(function() {
            ...
            $(".save_sq_btn").on("click", function() {
                ...
                console.log(title)
                myAjx.post("/index.php/teacher/sqlive_sub", {
                        "fid": fid,
                        "cat_id": cat_id,
                        "title": title,
                        "image": base64Images,
                    ...
                    function(data) {
                        if (data.status == 1) {
                            $(".save_sq_mask").fadeIn(200, function() {});
                        }
                    })
            })
        })
